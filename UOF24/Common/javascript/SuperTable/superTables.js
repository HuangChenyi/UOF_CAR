...
var superTable = function (tableId, options) {
    ...
    this.scrollTop = parseInt(options.scrollTop || "0");
    this.scrollLeft = parseInt(options.scrollLeft || "0");
    this.scrollWidth = parseInt(options.scrollWidth || "0");
    ...
    this.sData.scrollTop = this.scrollTop;
    this.sData.scrollLeft = this.scrollLeft;
