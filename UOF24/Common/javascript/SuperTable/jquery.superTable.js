    ...
    $.fn.extend(
            {
                toSuperTable: function (options) {
                    ...
                    var setting = $.extend(
                    {
                        width: window.innerWidth - diffParam[options.source].diffWidth,
                        height: window.innerHeight - diffParam[options.source].diffHeight,
                        margin: "10px", 
                        padding: "0px",
                        overflow: "hidden", 
                        colWidths: undefined,
                    ...
                    return this.each(function () {
                        ...
                        var nonCssProps = ["fixedCols", "headerRows", "onStart", "onFinish", "cssSkin", "colWidths", "scrollTop", "scrollLeft","scrollWidth"];
