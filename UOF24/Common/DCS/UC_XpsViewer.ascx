        ...
        <telerik:RadToolBar ID="RadToolBar2" runat="server"  Visible="False" >
            <Items>
                <telerik:RadToolBarButton runat="server" Text="" ToolTip="Rotate" Value="Rotate" 
                    ...
                    CheckedImageUrl="~/dms/images/docviewer/rotate2.png" >
                </telerik:RadToolBarButton>
                ...
                <telerik:RadToolBarButton runat="server" Value="sepBtnDownload" IsSeparator="true"></telerik:RadToolBarButton>
                <telerik:RadToolBarButton runat="server" Value="Download" ToolTip="Download"   ImageUrl="~/Common/images/Icon/icon_m226.png">
                </telerik:RadToolBarButton>
        ...
        <script type="text/javascript">
            ...
            function body_ready_<%=ClientID %>() {
               ...
               <%-- if (Number(<%=ClientID %>m_UgWidth) === 1160)
                ...
                if ($("#<%=hdnUgHeight.ClientID %>").val() !== "") {
                    <%=ClientID %>m_UgHeight = '<%=PageRatio%>' * <%=ClientID %>m_UgWidth * <%=ClientID %>defaultWidth;
                } else {
            ...
            <%--function ratiochange_<%=ClientID %>(selectitemid) {
               ...
               // $('#<%=ClientID %> .ug-image-container').width($("#<%=hdnUgWidth.ClientID %>").val());
                $('#<%=ClientID %> .ug-image-container').width(orgwidth);
                if ($("#<%=hdnUgWidth.ClientID %>").val() !== "") {
