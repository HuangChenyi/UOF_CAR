        ...
        <script type="text/javascript">
                ...
                $('#txbKeyWordUser').keypress(function (event) {
                    if (event.keyCode == 10 || event.keyCode == 13) {
                        ...
                        $(this).doTimeout("findEmpName",
                            500, Choice.searchUserByDeptLimit($uof.tool.htmlDecode(hfUserGuid),true, $uof.tool.htmlDecode(hfDisplayAllDept)));
                    }
                }).keyup(
                    function (event) {
                        $(this).doTimeout("findEmpName",
                ...
                $('#txbKeyWordDept').keypress(function (event) {
                    if (event.keyCode == 10 || event.keyCode == 13) {
                        ...
                        $(this).doTimeout("findDeptName",
                            500, Choice.searchDepartmentByLimit($uof.tool.htmlDecode(hfUserGuid), $uof.tool.htmlDecode(hfDisplayAllDept)));
                    }
                }).keyup(
                    function (event) {
                        $(this).doTimeout("findDeptName",
            ...
            function treeFavorite_NodeClicked(sender, args) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    dataType: "json",
                    data: { "action": "GetFavorite", "favoriteGuid": node.get_value(), "expandToUser": $uof.tool.htmlDecode(expandToUser), "showEmployee": $uof.tool.htmlDecode(showEmployee), "showMember": $uof.tool.htmlDecode(showMember) }
            ...
            function onSearchUserFindClicking(sender, args) {
                ...
                Choice.searchUserByDeptLimit($uof.tool.htmlDecode(hfUserGuid), $uof.tool.htmlDecode(hfDisplayAllDept));
            }
            ...
            function onSearchDeptFindClicking(sender, args) {
                ...
                if (Choice.Config.departmentCache == null) {
                    Choice.searchDepartmentByLimit($uof.tool.htmlDecode(hfUserGuid), $uof.tool.htmlDecode(hfDisplayAllDept));
                } else {
