...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript" src="../../Common/javascript/jQuery/plugin/jquery.ba-dotimeout.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        Sys.Application.add_load(function () {
            ...
            function searchUser()
            {
                ...
                var userType;
                var userGuid = $uof.tool.htmlDecode(hfUserGuid);
                ...
                Choice.submitSearchUser({ "action": "SearchUserByID", "userType": userType, "keyword": $("#txbKeyWordUser").val(), "id": groupID, "userGuid": userGuid, "displayAllDept": '<%=DisplayAllDept%>', "showSubDept": '<%=ShowSubDept%>', "sendSameDept": '<%=SendSameDept%>' });
            }
            ...
            function searchDept() {
                ...
                if (typeof (groupID) == 'undefined')
                    groupID = '';
                Choice.searchDepartmentByGroupID({ "action": "SearchDepartmentByGroupID", "keyword": keyword, "id": groupID, "displayAllDept": '<%=DisplayAllDept%>' });
            }
        ...
        function treeDepartment_NodeClicked(sender, args) {
            ...
            if (Choice.Config.currentMode == Choice.ChoiceType.DepartmentUser) {
                Choice.submitSearchUser({ "action": "GetDepartmentUser", "id": node.get_value(), "displayAllDept": '<%=DisplayAllDept%>' });
                $("#<%=hiddenSelectedDeptId.ClientID%>").val(node.get_value());
            }
        }
        ...
        function Button2Click() {
            $uof.dialog.open2("~/Common/ChoiceCenter/ChoicePreView.aspx", "", "", 700, 650, function (returnValue) { return false; }, {"displayAllDept":'<%=DisplayAllDept%>'});
            return false;
        }
...
<asp:HiddenField ID="hiddenSelectedDeptId" runat="server" />
