<%@ Page Title="選取人員" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="LimitChoiceCenterWithoutExpand.aspx.cs" Inherits="Common_ChoiceCenter_LimitChoiceCenterWithoutExpand" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                    ...
                    <div id="tabStripDiv" style="height: auto; padding: 2px">
                        <telerik:RadTabStrip ID="RadTabStrip1" runat="server" OnClientTabSelected="onClientTabSelected" SelectedIndex="0" meta:resourcekey="RadTabStrip1Resource1">
                            <Tabs>
                                ...
                                <telerik:RadTab runat="server" Text="部門員工" Value="DepartmentUser" meta:resourcekey="RadTabResource8">
                                </telerik:RadTab>
                    ...
                    <div id="divTreeContainer">
                        <div id="divDepartment" class="divContainer">
                            <div style="height: 25px;clear:both" id="divAllowSubDept">
                                <asp:CheckBox ID="cbAllowSubDept" runat="server" Text="包含子部門" Checked="true" meta:resourcekey="cbAllowSubDeptResource1" />
                            </div>
                        ...
                        <div id="divDepartmentUser" class="divContainer">
                            <div class="divTreeBody">
                                <telerik:RadTreeView ID="treeDepartmentUser" CssClass="treeBackgroundColor" runat="server" Height="100%" Width="100%" ShowLineImages="False" OnClientNodeClicked="treeDepartmentUser_NodeClicked" EnableNodeTextHtmlEncoding="true" ></telerik:RadTreeView>
                            </div>
                        </div>
    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script src="../javascript/ChoiceCenterV2.js?v=1"></script>
        <script type="text/javascript">
            ...
            Sys.Application.add_load(function () {
                ...
                switch (type) {
                    ...
                    case 1: //部門員工
                        {
                            $('#divDepartmentUser').css({ 'background-color': '#d9d9d9' });
                            $("#divDepartmentUser").show();
                            $("#divUser").show();
                        }
                        break;
            ...
            function treeDepartment_NodeClicked(sender, args) {
                ...
                Choice.Config.currentMode = 0;
                Choice.addToResult(Choice.Config.currentMode, null, null, node.get_text(), node.get_value(), depth);
            }

            function treeDepartmentUser_NodeClicked(sender, args) {
                var node = args.get_node();
            ...
            function treeDeptTitle_NodeClicked(sender, args) {
                var node = args.get_node();
                var para = node.get_value().split("|");
                var depth = para[2] == 1 ? true : false;

                Choice.Config.currentMode = 2;
                Choice.addToResult(Choice.Config.currentMode, node.get_text(), para[4], null, para[3], depth, false);
            }
                            ...
                            case 'DepartmentUser':
                                {
                                    ...
                                    var tree = $find("<%= treeDepartmentUser.ClientID %>");
            ...
            function Radsplitter2afterResize(s, a) {
                ...
                $(".divTreeBody").height(s.get_height() - (tabHiehgt + 20));
    ...
    <asp:Label ID="lblPreView" runat="server" Text="預覽" Visible="False" meta:resourcekey="lblPreViewResource1"></asp:Label>
