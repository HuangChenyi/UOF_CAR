<%@ Page Title="申請明細" Language="C#" MasterPageFile="~/Master/MobileMasterPage.master" AutoEventWireup="true" CodeBehind="OverTimeBatchDetailAdv.aspx.cs" Inherits="Ede.Uof.Web.HR104.Duty.Report.OverTimeBatchDetailAdv" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
                            ...
                            <Items>
                                <telerik:RadToolBarButton runat="server" Value="Keyword" meta:resourcekey="RadToolBarButtonResource4">
                                    <ItemTemplate>
                                        ...
                                        <telerik:RadTextBox ID="txtKeyWord" runat="server" Resize="None"></telerik:RadTextBox>
