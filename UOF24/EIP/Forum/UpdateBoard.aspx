<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="EIP_Forum_UpdateBoard" Title="修改討論版" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="UpdateBoard.aspx.cs" %>

<%@ Register Src="../../Common/ChoiceCenter/UC_ChoiceList.ascx" TagName="UC_ChoiceList"
    TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:CustomValidator ID="CustomValidator1" runat="server" Display="Dynamic" ForeColor="Red" ErrorMessage="討論版名稱已存在" meta:resourcekey="CustomValidator1Resource1"></asp:CustomValidator>
    <asp:CustomValidator ID="CustomValidator2" runat="server" Display="Dynamic" ForeColor="Red" ErrorMessage="無權限維護" meta:resourcekey="CustomValidator2Resource1"></asp:CustomValidator>
    <table width="100%" class="PopTable" cellspacing="1">
        <tr>
            <td style="height: 21px; white-space: nowrap;">
                <asp:Label ID="Label1" runat="server" Text="討論區名稱" meta:resourcekey="Label1Resource1"></asp:Label></td>
            <td style="height: 21px">
                <asp:Label ID="lblArea" runat="server" meta:resourcekey="lblAreaResource1"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="height: 21px">
            ...
            <td style="height: 21px">
                <asp:TextBox ID="txtBoardName" runat="server" Width="100%" MaxLength="50" meta:resourcekey="txtBoardNameResource1"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="請輸入討論版名稱" ControlToValidate="txtBoardName" Display="Dynamic" ForeColor="Red" meta:resourcekey="RequiredFieldValidator1Resource1"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td style="height: 21px">
        ...
        <tr>
            ...
            <td>
                <asp:RadioButtonList ID="rbtPostedDisplay" runat="server"
                    ...
                    <asp:ListItem Value="0" meta:resourcekey="ListItemResource1">顯示姓名</asp:ListItem>
