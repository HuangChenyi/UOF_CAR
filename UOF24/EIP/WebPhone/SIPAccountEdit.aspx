        ...
        <ContentTemplate>
            ...
            <table class="PopTable" cellspacing="1">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtAccount" runat="server" Enabled="False" Width="100%"
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPWD" runat="server" meta:resourcekey="txtPWDResource1" Width="100%"></asp:TextBox>
