...
<script type="text/javascript" >
    ...
    function CheckYearLeaveInRange(source, args) {
        ...
        if (leaveCode != "-NULL-" && leaveCode == "YearLeave") {
            ...
            {
                // extend送到pageMethod做判斷
                var ddlLeaveDays = $find("<%= ddlLeaveDays2.ClientID %>").get_selectedItem().get_value();
                var extend = '';
                if (ddlLeaveDays != null && ddlLeaveDays != '-NULL-') {
                    extend = ddlLeaveDays.split('@')[1];
                }

                var startDateVlaue = startDate.get_selectedDate().format('yyyy/MM/dd');
                var endDateVlaue = endDate.get_selectedDate().format('yyyy/MM/dd');
                var data = [applicantGuid, startDateVlaue, endDateVlaue, extend];
    ...
    <tr>
        ...
        <td class="PopTableRightTD">
            <table style="width: 100%;">
                ...
                <tr>
                    <td colspan="2">
                        <telerik:RadDatePicker ID="rdActualDate" SkinID="AllowEmpty" runat="server" meta:resourcekey="rdActualDateResource4">
