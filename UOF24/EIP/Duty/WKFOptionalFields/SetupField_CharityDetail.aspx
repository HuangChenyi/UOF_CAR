<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKFOptionalFields_SetupField_CharityDetail" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SetupField_CharityDetail.aspx.cs" %>
    ...
    <tr>
        <td align="center" class="PopTableHeader" colspan="4">
            <div style=" text-align:center;">
                <asp:Label ID="lblSingleLine" runat="server" Text="公益活動維護" meta:resourcekey="lblSingleLineResource1"></asp:Label>
            </div>
        </td>
    </tr>
    <tr>
