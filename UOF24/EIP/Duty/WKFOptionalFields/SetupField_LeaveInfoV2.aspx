<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_OptionalFields_SetupField_LeaveInfoV2" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SetupField_LeaveInfoV2.aspx.cs" %>
    ...
    <tr>
        ...
        <td>	<asp:Label ID="lblSeq" runat="server" meta:resourcekey="lblSeqResource1"></asp:Label>
            ...
            <td >
                ...
                <asp:CheckBox ID="cbExceptionLeave" Text="允許特殊情況請假" runat="server" meta:resourcekey="cbExceptionLeaveResource1" />
            </td>
        </tr>
