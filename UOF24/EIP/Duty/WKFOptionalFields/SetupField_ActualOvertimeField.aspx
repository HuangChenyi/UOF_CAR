<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_OptionalFields_SetupField_ActualOvertimeField" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SetupField_ActualOvertimeField.aspx.cs" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    <tr>
        ...
        <center>
        <asp:Label ID="lblSingleLine" runat="server" Text="實際加班資訊" meta:resourcekey="lblSingleLineResource1"></asp:Label></center></td>
    </tr>
    <tr>
        ...
        <td style="height: 26px">
            ...
            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtFieldId" ForeColor="Red" Display="Dynamic" ErrorMessage="輸入內容只允許英文或數字" ValidationExpression="\w*" meta:resourcekey="RegularExpressionValidator1Resource1"></asp:RegularExpressionValidator>
            <br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorFieldId" runat="server" ErrorMessage="請輸入欄位代號" ControlToValidate="txtFieldId" ForeColor="Red" Display="Dynamic" meta:resourcekey="RequiredFieldValidatorFieldIdResource1"></asp:RequiredFieldValidator>
            <asp:CustomValidator ID="CustomValidatorFieldId" runat="server" ErrorMessage="同一表單版本的欄位代號不得重複" Display="Dynamic" meta:resourcekey="CustomValidatorFieldIdResource1" ForeColor="Red"></asp:CustomValidator>
        </td>
        ...
        <td style="height: 26px">
            ...
            <br />
            <asp:RequiredFieldValidator ID="RequiredFieldValidatorFieldName" runat="server" ErrorMessage="請輸入欄位名稱" ForeColor="Red" ControlToValidate="txtFieldName" Display="Dynamic" meta:resourcekey="RequiredFieldValidatorFieldNameResource1"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
    ...
    <tr id="GrideDetail" runat="server">
        ...
        <td colspan="3">
            <telerik:RadNumericTextBox ID="rdNumericViewLength" runat="server" DataType="System.Int32" MaxLength="5" MaxValue="1000" MinValue="0" Width="40px" Value="0"></telerik:RadNumericTextBox>
