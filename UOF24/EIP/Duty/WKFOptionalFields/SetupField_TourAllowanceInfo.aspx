<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_OptionalFields_SetupField_TourAllowanceInfo" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SetupField_TourAllowanceInfo.aspx.cs" %>
    ...
    <tr>
        <td align="center" class="PopTableHeader" colspan="4">
            <div style=" text-align:center;">
                <asp:Label ID="lblSingleLine" runat="server" Text="旅遊補助資訊" meta:resourcekey="lblSingleLineResource1"></asp:Label>
            </div>
        </td>
    </tr>
    <tr>
