...
<script type="text/javascript">
    Sys.Application.add_load(function () {
        ...
        var hfIsDayValid = $('#<%= hfIsDayValid.ClientID  %>').val();
        var hfIsMonthValid = $('#<%= hfIsMonthValid.ClientID  %>').val();
        var hfIsSeasonValid = $('#<%= hfIsSeasonValid.ClientID  %>').val();
        var hfIsCounted = $('#<%= hfIsCounted.ClientID  %>').val();
        var hfIsWarningShow = $('#<%= hfIsWarningShow.ClientID  %>').val();
        ...
        if (hfIsDayValid !== "") {
            lblMoreThanLawHoursMsg.text(hfIsDayValid);
            lblMoreThanLawHoursMsg.css("display", "");
        }
        if (hfIsMonthValid !== "") {
            lblMoreThanLawHoursMsg2.text(hfIsMonthValid);
            lblMoreThanLawHoursMsg2.css("display", "");
        }
        if (hfIsSeasonValid !== "") {
            lblMoreThanLawHoursMsg3.text(hfIsSeasonValid);
        ...
        if (ovtType == "0" && hfWorkType !== "") {
            ...
            if (arr.length >= 4) {
                ...
                //當季超時仍可加班
                    ...
                    lblMoreThanLawHoursMsg3.css("display", "");
                    lblMoreThanLawHoursMsg3.text(errorMsg.format(lblSeason, arr[2], arr[3], ""));
    ...
    function CheckUsersOverTime(e, args) {
        ...
        if (ovtType == "1") {
            ...
            var data = [$('#<%= hfPreViewTimeTableUsers.ClientID  %>').val(), belnogDate, "<%=m_TaskID%>", hfWorkType, actHours];
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                                <asp:CustomValidator ID="cvCheckDayLimit" runat="server" 
                                    Display="Dynamic" ClientValidationFunction="CheckDayLimit" meta:resourcekey="cvCheckDayLimitResource1"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CustomValidator ID="cvCheckMonthLimit" runat="server" 
                                    Display="Dynamic" ClientValidationFunction="CheckMonthLimit" meta:resourcekey="cvCheckMonthLimitResource1"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CustomValidator ID="cvCheckSeasonLimit" runat="server" 
                                    Display="Dynamic" ClientValidationFunction="CheckSeasonLimit" meta:resourcekey="cvCheckSeasonLimitResource1"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CustomValidator ID="cvCheckUsersOverTime" runat="server" Display="Dynamic"
                        ...
                        <tr>
                            <td>
                                <asp:CustomValidator ID="cvIsOverLimit" runat="server" Display="Dynamic"
...
<asp:Label ID="lblTypeMiss" runat="server" Text="所選擇給付方式已被修改或移除，請洽系統管理員" Visible="false" ForeColor="Red" meta:resourcekye="lblTypeMissResource1"></asp:Label>
