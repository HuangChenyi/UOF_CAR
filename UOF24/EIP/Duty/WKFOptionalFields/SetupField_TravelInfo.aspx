<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKFOptionalFields_SetupField_TravelInfo" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SetupField_TravelInfo.aspx.cs" %>
    ...
    <tr>
        <td align="center" class="PopTableHeader" colspan="4">
            <div style=" text-align:center;">
                <asp:Label ID="lblSingleLine" runat="server" Text="出差資訊" meta:resourcekey="lblSingleLineResource1"></asp:Label>
            </div> 
        </td>
    </tr>
    <tr>
