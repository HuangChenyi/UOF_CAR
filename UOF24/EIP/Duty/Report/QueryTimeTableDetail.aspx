<%@ Page Title="班表" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="EIP_Duty_Report_QueryTimeTableDetail"  meta:resourcekey="PageResource1" Codebehind="QueryTimeTableDetail.aspx.cs" %>
                                            ...
                                            <asp:TemplateField HeaderText="備註"   
                                                ...
                                                <ItemTemplate>
                                                   <%-- <asp:Label ID="lblRemark" runat="server" Text='<%#Eval("REMARK") %>'></asp:Label>--%>
                                                    <asp:TextBox ID="txtRemark" Width="100%" runat="server" Rows="2" TextMode="MultiLine" ReadOnly="true" Text='<%#Eval("REMARK") %>'  ></asp:TextBox>                                                   
                                                </ItemTemplate>
                                                <HeaderStyle Wrap="False" />
                                            </asp:TemplateField>                                            
