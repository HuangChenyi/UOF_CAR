<%@ Page Title="維護只可用App權限" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="PunchUseOnlyAPPEdit.aspx.cs" Inherits="EIP_Duty_Punch_PunchUseOnlyAPPEdit" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:HiddenField ID="hfPunchUseOnlyAPPGuid" runat="server" />
