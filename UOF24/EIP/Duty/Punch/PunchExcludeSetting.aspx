<%@ Page Title="特殊人員" Language="C#" MasterPageFile="~/Master/DefaultMasterPage.master" AutoEventWireup="true" CodeBehind="PunchExcludeSetting.aspx.cs" Inherits="EIP_Duty_Punch_PunchExcludeSetting" meta:resourcekey="PageResource1" culture="auto" uiculture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script id="punchJS" type="text/javascript">
        ...
        function rtbPunchExcludeMaintainClicking(sender, args) {
            ...
            switch (key) {
                case "Add":
                    ...
                    $uof.dialog.open2("~/EIP/Duty/Punch/PunchExcludeEdit.aspx", args.get_item(), '<%=lblDialogTitle.Text %>', 600, 450, openDialogResult, { 'currentUser': currentUser });
                    break;
    ...
    <telerik:RadTabStrip ID="rtsPunchExclude" runat="server" SelectedIndex="0" MultiPageID="rmpPunchExclude" meta:resourcekey="rtsPunchExcludeResource1">
        <Tabs>
            <telerik:RadTab runat="server" Text="特殊人員" PageViewID="rpvPunchExcludeMaintain" meta:resourcekey="rpvPunchExcludeMaintainResource1"></telerik:RadTab>
            <telerik:RadTab runat="server" Text="權限設定" PageViewID="rpvAuthSetting" meta:resourcekey="rpvAuthSettingResource1"></telerik:RadTab>
        </Tabs>
    </telerik:RadTabStrip>

    <telerik:RadMultiPage ID="rmpPunchExclude" runat="server" SelectedIndex="0" meta:resourcekey="rmpPunchExcludeResource1">
        
        <telerik:RadPageView ID="rpvPunchExcludeMaintain" runat="server" Width="100%" meta:resourcekey="rpvPunchExcludeMaintainResource2" Selected="True">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <table style="width:100%; height: 100%;">
                        <tr>
                            <td valign="top">
                                <telerik:RadToolBar ID="rtbPunchExcludeMaintain" runat="server" Width="100%" 
                                    OnButtonClick="rtbPunchExcludeMaintain_OnButtonClick" OnClientButtonClicking="rtbPunchExcludeMaintainClicking" meta:resourcekey="rtbPunchExcludeMaintainResource1" SingleClick="None">
                                    <Items>
                                        ...
                                        <telerik:RadToolBarButton runat="server" meta:resourcekey="RadToolBarButtonResource5">
                                            <ItemTemplate>
                                                &nbsp;
                                                <asp:Label ID="lblRuleTip" runat="server" Text="說明：特殊人員不受刷卡設定限制。" CssClass="SizeMemo" meta:resourcekey="lblRuleTipResource1"></asp:Label>
                                            </ItemTemplate>
                                        </telerik:RadToolBarButton>
                                    </Items>
                                </telerik:RadToolBar>

                                <Ede:Grid ID="grdPunchExcludeMaintain" runat="server" 
                                    AllowPaging="True" 
                                    AllowSorting="True" 
                                    AutoGenerateCheckBoxColumn="True"
                                    AutoGenerateColumns="False" 
                                    DataKeyNames="PUNCH_EXCLUDE_GUID"
                                    DataKeyOnClientWithCheckBox="True"
                                    DefaultSortColumnName="MODIFY_DATE"
                                    DefaultSortDirection="Descending"
                                    EmptyDataText="沒有資料" 
                                    EnhancePager="True" 
                                    OnPageIndexChanging="grdPunchExcludeMaintain_PageIndexChanging"
                                    OnRowDataBound="grdPunchExcludeMaintain_RowDataBound" 
                                    OnSorting="grdPunchExcludeMaintain_Sorting"
                                    PageSize="15"
                                    KeepSelectedRows="False" 
                                    Width="100%" CustomDropDownListPage="False" meta:resourcekey="grdPunchExcludeMaintainResource1" SelectedRowColor="" UnSelectedRowColor="">
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="狀態" meta:resourcekey="tfStatusResource1">
                                         ...
                                         <asp:TemplateField HeaderText="人員" meta:resourcekey="tfUserSetResource1">
                                            <ItemTemplate>
                                                <uc1:UC_ChoiceList runat="server" ID="UC_ChoiceList_Exclude" IsAllowEdit="False" />
                                            </ItemTemplate>
    ...
    <asp:Label ID="lblDialogTitle" runat="server" Text="特殊人員" Visible="False" meta:resourcekey="lblDialogTitleResource1"></asp:Label>
