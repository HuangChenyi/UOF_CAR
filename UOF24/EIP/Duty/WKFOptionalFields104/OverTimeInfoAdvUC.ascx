    ...
    <ContentTemplate>
        ...
        <table class="PopTable" style="width: 100%">
            <tr>
                ...
                <td id="td1" runat="server" colspan="3">
                    <asp:RadioButtonList ID="rblOverTimeTypeAdv" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rblOverTimeTypeAdv_SelectedIndexChanged" meta:resourcekey="rblAdvOverTimeTypeResource1">
            ...
            <tr>
                ...
                <td style="width: 35%">
                    <table>
                        <tr>
                            <td>
                                <telerik:RadDatePicker ID="rdStartDateAdv" runat="server" AutoPostBack="True" OnSelectedDateChanged="rdStartDateAdv_SelectedDateChanged" meta:resourcekey="rdStartDateResource1">
                                </telerik:RadDatePicker>
                            </td>
                            <td>
                                <asp:Label ID="lblStartDateAdv" runat="server" Visible="False" meta:resourcekey="lblStartDateResource1"></asp:Label>
                                <telerik:RadTimePicker ID="rdStartTimeAdv" runat="server" AutoPostBack="True" OnSelectedDateChanged="rdStartDateTimeAdv_SelectedDateChanged" meta:resourcekey="rdStartTimeResource1">
                ...
                <td style="width: 35%">
                    <table>
                        <tr>
                            <td>
                                <telerik:RadDatePicker ID="rdEndDateAdv" runat="server" AutoPostBack="True" OnSelectedDateChanged="rdStartDateTimeAdv_SelectedDateChanged" meta:resourcekey="rdEndDateResource1">
                                </telerik:RadDatePicker>
                            </td>
                            <td>
                                <asp:Label ID="lblEndDateAdv" runat="server" Visible="False" meta:resourcekey="lblEndDateResource1"></asp:Label>
                                <telerik:RadTimePicker ID="rdEndTimeAdv" runat="server" AutoPostBack="True" OnSelectedDateChanged="rdStartDateTimeAdv_SelectedDateChanged" meta:resourcekey="rdEndTimeResource1">
                                </telerik:RadTimePicker>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                ...
                <td id="tdExcludeHoursAdv" runat="server" colspan="3">
                    <asp:CheckBoxList ID="cblExcludeHoursAdv" runat="server" RepeatDirection="Horizontal" AutoPostBack="true" OnSelectedIndexChanged="cblExcludeHoursAdv_SelectedIndexChanged" meta:resourcekey="cblExcludeHoursResource1">
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <telerik:RadTextBox ID="txtRemarkAdv2" runat="server" Width="100%" AutoPostBack="true" OnTextChanged="txtRemarkAdv2_TextChanged"
                        TextMode="MultiLine" Rows="3"  meta:resourcekey="txtRemarkResource1"></telerik:RadTextBox>
                    <asp:RequiredFieldValidator ID="cvRemarkAdv" Display="Dynamic" ForeColor="Red" runat="server"
                        ErrorMessage="不可空白" ControlToValidate="txtRemarkAdv2" Visible="false" meta:resourcekey="cvRemarkResource1"></asp:RequiredFieldValidator>
                </td>
            </tr>
        </table>
        <br />
        ...
        <table class="PopTable" style="width: 100%">
            <tr>
                ...
                <td id="tdOverTimeType" style="width: 35%" runat="server">
                    <asp:RadioButtonList ID="rblOverTimeType" runat="server" RepeatDirection="Horizontal" AutoPostBack="True" OnSelectedIndexChanged="rblOverTimeType_SelectedIndexChanged" meta:resourcekey="rblOverTimeTypeResource1">
                        <asp:ListItem Text="轉加班費" Value="Payment" meta:resourcekey="ListItemResource1" ></asp:ListItem>
                        <asp:ListItem Text="轉補休" Value="TimeOff" meta:resourcekey="ListItemResource2"></asp:ListItem>
                    </asp:RadioButtonList>
                ...
                <td id="tdMealAllowance" style="width: 35%" runat="server">
                    <asp:RadioButtonList ID="rblMealAllowance" runat="server" RepeatDirection="Horizontal" meta:resourcekey="rblMealAllowanceResource1">
            ...
            <tr>
                ...
                <td style="width: 35%" id="tdExcludeHours" runat="server">
                ...
                <td style="width: 35%;" id="tdPunchCheck" runat="server">
                    <asp:Label ID="lblPunchCheck" runat="server" Visible="False" meta:resourcekey="lblPunchCheckResource1"></asp:Label>
                    <asp:RadioButtonList ID="rblPunchCheck" runat="server" RepeatDirection="Horizontal" meta:resourcekey="rblPunchCheckResource1">
        ...
        <table>
            ...
            <tr>
                <td>
                    <asp:CustomValidator ID="cvCal" runat="server" ErrorMessage="請先計算加班時數" Display="Dynamic" meta:resourcekey="cvCalResource1"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:CustomValidator ID="cvDateRange" runat="server" Display="Dynamic" ErrorMessage="實際加班時段需在預計加班時間範圍內" ForeColor="Red" meta:resourcekey="cvDateRangeResource1"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:TextBox ID="txtError" runat="server" Style="display: none; width: 300px; border-width: 0;" ReadOnly="True" ForeColor="Red" meta:resourcekey="txtErrorResource1"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
