...
<script type="text/javascript">
    function ValidateApply_<%=ClientID%>(source, arguments) {
        ...
        var ddlTravelList = $('#<%=ddlTravelList.ClientID %> option:selected');
        ...
        if ($("#<%=hfAllowModify.ClientID%>").val() === 'true' &&
            ddlTravelList != null &&
            (ddlTravelList.val() === 'null' || ddlTravelList.val() == null)) {
    ...
    function Show104Setting_<%=ClientID%>() {
        ...
        if (showCashAdcance === 'false') {
            ...
            $("#trAdvanceAmount").attr("style", "display:none");
        }
    }
</script>
            ...
            <tr>
                ...
                <td colspan="3">
                    <table>
                        <tr>
                            <td>
                                <telerik:RadDropDownList ID="ddlMTravelList" runat="server" OnSelectedIndexChanged="ddlMTravelList_SelectedIndexChanged" AutoPostBack="True"  EnableTheming="True" CausesValidation="False" style="display:none" meta:resourcekey="ddlMTravelListResource1"></telerik:RadDropDownList>
                                <asp:DropDownList ID="ddlTravelList" runat="server" OnSelectedIndexChanged="ddlTravelList_SelectedIndexChanged" AutoPostBack="True" meta:resourcekey="ddlTravelListResource1">
                                </asp:DropDownList>
