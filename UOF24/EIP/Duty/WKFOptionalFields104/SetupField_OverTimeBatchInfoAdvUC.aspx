<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="SetupField_OverTimeBatchInfoAdvUC.aspx.cs" Inherits="Ede.Uof.Web.EIP.Duty.WKFOptionalFields104.SetupField_OverTimeBatchInfoAdvUC" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
    ...
    <tr>
        <td align="center" class="PopTableHeader" colspan="4">
            <div style=" text-align:center;">
                <asp:Label ID="lblSingleLine" runat="server" Text="加班資訊" meta:resourcekey="lblSingleLineResource1" ></asp:Label>
            </div>           
        </td>
    </tr>
    <tr>
