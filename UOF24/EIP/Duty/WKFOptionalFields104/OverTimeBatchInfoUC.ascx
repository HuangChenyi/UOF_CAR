...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>        
            ...
            <tr>
                ...
                <td style="width: 35%" id="tdExcludeHours" runat="server">
                    <asp:CheckBoxList ID="cblExcludeHours" runat="server" RepeatDirection="Horizontal" meta:resourcekey="cblExcludeHoursResource1">
                        <asp:ListItem Text="午餐(1)" Value="Lunch|1" meta:resourcekey="ListItemResource5"></asp:ListItem>
                        <asp:ListItem Text="晚餐(2)" Value="Dinner|2" meta:resourcekey="ListItemResource6"></asp:ListItem>
                        <asp:ListItem Text="宵夜(4)" Value="Supper|4" meta:resourcekey="ListItemResource7"></asp:ListItem>
                        <asp:ListItem Text="其他(8)" Value="Other|8" meta:resourcekey="ListItemResource8"></asp:ListItem>
                    </asp:CheckBoxList>
        ...
        <table>
            <tr>
                <td>
                      <asp:CustomValidator ID="cvCheckDate" runat="server" ErrorMessage="日期錯誤:輸入之結束日期(時間) 小於 開始日期(時間),請重新申請表單,謝謝!!" ClientValidationFunction="CheckDate"  Display="Dynamic" meta:resourcekey="cvCheckDateResource1"></asp:CustomValidator>
                      <asp:CustomValidator ID="cvMissingInfo" runat="server" ErrorMessage="無員工編號或公司統一編號資訊" Display="Dynamic" Visible="False" meta:resourcekey="cvMissingInfoResource1"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <asp:HiddenField ID="hfCalcPass" runat="server" />
