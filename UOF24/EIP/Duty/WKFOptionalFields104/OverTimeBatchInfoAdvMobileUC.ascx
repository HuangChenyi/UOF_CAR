    ...
    function PriorCheck(source, args) {
        ...
        if (fieldMode == "Applicant" && needPriorCheck == "True") {
            ...
            if (!(items === null || items === '[]' || items === '')) {
                ...
                if (PriorCheckState == '') {
                    args.IsValid = false;
                    source.innerHTML = $("#<%=lblApplylessForApp.ClientID%>").text();
                }
                else {
...
<asp:UpdatePanel ID="UpdatePanelOverTimeBatch" runat="server">
    <ContentTemplate>
        ...
        <div runat="server" id="divAddOverTimeDetail" style="padding-bottom: 5px;">
            <telerik:RadButton ID="rdbtnAddDetail" runat="server" Text="新增明細" CausesValidation="False" OnClick="rdbtnAddDetail_Click" meta:resourcekey="rdbtnAddDetailResource1" Visible="False"></telerik:RadButton>
            <telerik:RadButton ID="rdbtnPriorCheck" runat="server" Text="計算時數" CausesValidation="false" OnClick="rdbtnPriorCheck_Click" meta:resourcekey="rdbtnPriorCheckResource1"></telerik:RadButton>
        ...
        <table style="width: 100%;">
            ...
            <tr>
                <td>
                    <Ede:Grid ID="grdOverTimeBatchAdv" runat="server" Width="100%" EnableTheming="True"
