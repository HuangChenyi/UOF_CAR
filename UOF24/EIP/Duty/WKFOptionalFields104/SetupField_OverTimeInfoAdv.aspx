<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="SetupField_OverTimeInfoAdv.aspx.cs" Inherits="Ede.Uof.Web.EIP.Duty.WKFOptionalFields104.SetupField_OverTimeInfoAdv" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <tr>
        ...
        <td colspan="3">
            <table>
                ...
                <tr>
                    <td>
                        <asp:CheckBox runat="server" ID="cbShowPunchCheck" Text="顯示檢查刷卡資料欄位" meta:resourcekey="cbShowPunchCheckResource1" /><br />
                        <asp:Label ID="lblShowPunchCheckMemo" runat="server" Text="勾選後在實際加班資訊中會顯示此欄位讓申請者填寫" CssClass="SizeMemo" meta:resourcekey="lblShowPunchCheckMemoResource1"></asp:Label>                        
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td>
            <asp:Label ID="lblRemarkTitle" runat="server" Text="事由欄位" meta:resourcekey="lblRemarkTitleResource1"></asp:Label>
        </td>
        <td colspan="3">
            <asp:CheckBox ID="cbRemarkRequired" runat="server" Text="申請者必填" Checked="False" meta:resourcekey="cbRemarkRequiredResource1" />
        </td>
    </tr>
    <tr>
        <td>
        ...
        <td colspan="3">
            <table>
                <tr>
                    <td>
                        <asp:CheckBox runat="server" ID="cbNeedApplyAdv" Text="需事前申請" Checked="True" meta:resourcekey="cbNeedApplyAdvResource1" />
                    </td>
                </tr>
                <tr>
                    <td>
                        <asp:CheckBox ID="cbOverTimeRangeInAdvRange" runat="server" Text="實際加班時段需在預計加班時間範圍內" Checked="True" meta:resourcekey="cbOverTimeRangeInAdvRangeResource1" />
                    </td>
                </tr>
            </table>
        </td>
