...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table class="ExchangeSectionTable104" style="width: 100%">
            ...
            <tr>
                <td>
                    <div id="choiceListMobile">
                        <uc2:UC_ChoiceListMobile runat="server" ID="UC_ChoiceListMobile" ChioceType="User" DoEditButton="true"/>
                    </div>
            ...
            <tr>
                <td>
                    <telerik:RadDatePicker ID="rdpExchangeStartDate" OnSelectedDateChanged="rdpExchangeStartDate_SelectedDateChanged" AutoPostBack="True" EnableTheming="true" runat="server"  meta:resourcekey="rdpExchangeStartDateResource1">
            ...
            <tr>
                <td>
                    <telerik:RadDatePicker ID="rdpExchangeEndDate" OnSelectedDateChanged="rdpExchangeEndDate_SelectedDateChanged" AutoPostBack="True" EnableTheming="true" runat="server"  meta:resourcekey="rdpExchangeEndDateResource1">
                        <Calendar Culture="zh-TW" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False">
                        </Calendar>
                        <DateInput AutoPostBack="True" DateFormat="yyyy/M/d" DisplayDateFormat="yyyy/M/d" LabelWidth="64px" Width="">
                            <EmptyMessageStyle Resize="None" />
