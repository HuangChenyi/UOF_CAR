<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_OptionalFields_SetupField_OverAttendReportUpadte" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SetupField_OverAttendReportUpadte.aspx.cs" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><asp:Label ID="lblSingleLine" runat="server" Text="104超時出勤原因修改" meta:resourcekey="lblSingleLineResource1"></asp:Label></td>
    </tr>
    <tr>
