...
<style type="text/css">
    ...
    .ExchangeSectionTable104 > tbody > tr:nth-child(even) > td {
        padding-left : 10px;
        padding-bottom: 15px;
    }

    .ExchangeSectionTable104 > tbody > tr:nth-child(odd) > td {
        padding-left : 10px;
        padding-bottom : 5px;
    }
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table class="ExchangeSectionTable104" style="width: 100%">
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <asp:DropDownList ID="ddlExchangeType" OnSelectedIndexChanged="ddlExchangeType_SelectedIndexChanged" Width="200px" AutoPostBack="True" runat="server" meta:resourcekey="ddlExchangeTypeResource1">
            ...
            <asp:Panel ID="pnlDate" runat="server" meta:resourcekey="pnlDateResource1">
                ...
                <tr>
                    <td>
                        <div id="mobileSingle">
                            <uc2:UC_ChoiceListMobile runat="server" ID="UC_ChoiceListMobile_Single" ChioceType="User"  DoEditButton="true"/>
                        </div>
                ...
                <tr>
                    <td>
                        <telerik:RadDatePicker ID="rdpExchangeDateSingle1" OnSelectedDateChanged="rdpExchangeDateSingle1_SelectedDateChanged" AutoPostBack="True" EnableTheming="true" runat="server" meta:resourcekey="rdpExchangeDateSingle1Resource1">
                ...
                <tr>
                    <td>
                        <telerik:RadDatePicker ID="rdpExchangeDateSingle2" OnSelectedDateChanged="rdpExchangeDateSingle2_SelectedDateChanged" AutoPostBack="True" EnableTheming="true" runat="server" meta:resourcekey="rdpExchangeDateSingle2Resource1">
                            <Calendar Culture="zh-TW" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False">
                            </Calendar>
                            <DateInput AutoPostBack="True" DateFormat="yyyy/M/d" DisplayDateFormat="yyyy/M/d" LabelWidth="64px" Width="">
                                <EmptyMessageStyle Resize="None" />
            ...
            <asp:Panel ID="pnlPerson" runat="server" Visible="False" meta:resourcekey="pnlPersonResource1">
                ...
                <tr>
                    <td>
                        <telerik:RadDatePicker ID="rdpExchangeDatePerson" OnSelectedDateChanged="rdpExchangeDatePerson_SelectedDateChanged" AutoPostBack="True" EnableTheming="true" runat="server" meta:resourcekey="rdpExchangeDatePersonResource1">
                            <Calendar Culture="zh-TW" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False">
                            </Calendar>
                            <DateInput AutoPostBack="True" DateFormat="yyyy/M/d" DisplayDateFormat="yyyy/M/d" LabelWidth="64px" Width="">
                                <EmptyMessageStyle Resize="None" />
                ...
                <tr>
                    <td>
                        <div id="mobilePerson1">
                            <uc2:UC_ChoiceListMobile runat="server" ID="UC_ChoiceListMobile_Person1" ChioceType="User" DoEditButton="true"/>
                        </div>
                        <div style="display:none;">
                ...
                <tr>
                    <td>
                        <div id="mobilePerson2">
                            <uc2:UC_ChoiceListMobile runat="server" ID="UC_ChoiceListMobile_Person2" ChioceType="User" DoEditButton="true"/>
                        </div>
                        <div style="display:none;">
        ...
        <table>
            <tr>
                <td>
                    <asp:CustomValidator ID="cvExchangeType" runat="server" Display="Dynamic" EnableTheming="True" ErrorMessage="調班類型不可為空" ClientValidationFunction="CheckExchangeType" meta:resourcekey="cvExchangeTypeResource1"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:CustomValidator ID="cvDate" runat="server" Display="Dynamic" EnableTheming="True" ErrorMessage="調班日期不可為空" ClientValidationFunction="CheckExchageDate" meta:resourcekey="cvDateResource1"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:CustomValidator ID="cvRemark" runat="server" Display="Dynamic" EnableTheming="True" ErrorMessage="事由不可空白" ClientValidationFunction="CheckRemarkRequired" meta:resourcekey="cvRemarkResource1"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:CustomValidator ID="cvExchangeSection" runat="server" Display="Dynamic" EnableTheming="True" ClientValidationFunction="CheckExchangeSection" meta:resourcekey="cvExchangeSectionResource1"></asp:CustomValidator>
                </td>
            </tr>
        </table>
    </ContentTemplate>
