<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="Ede.Uof.Web.EIP.Duty.WKFOptionalFields104.SetupField_SingleExchangeSectionInfo" Title="" Culture="auto" UICulture="auto" CodeBehind="SetupField_SingleExchangeSectionInfo.aspx.cs" meta:resourcekey="PageResource1"%>
    ...
    <tr>
        <td align="center" class="PopTableHeader" colspan="4">
            <div style=" text-align:center;">
                <asp:Label ID="lblSingleLine" runat="server" Text="調班資訊(單人)" meta:resourcekey="lblSingleLineResource1"></asp:Label>
            </div>
        </td>
    </tr>
    <tr>
