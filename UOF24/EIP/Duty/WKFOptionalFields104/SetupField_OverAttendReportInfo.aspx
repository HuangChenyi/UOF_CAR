<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="SetupField_OverAttendReportInfo.aspx.cs" Inherits="Ede.Uof.Web.EIP.Duty.WKFOptionalFields104.SetupField_OverAttendReportInfo" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <tr>
        <td align="center" class="PopTableHeader" colspan="4">
            <div style=" text-align:center;">
                <asp:Label ID="lblSingleLine" runat="server" Text="超時出勤回報資訊" 
