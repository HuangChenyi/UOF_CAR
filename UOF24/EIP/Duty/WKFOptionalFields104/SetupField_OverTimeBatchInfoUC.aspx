<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="SetupField_OverTimeBatchInfoUC.aspx.cs" Inherits="Ede.Uof.Web.EIP.Duty.WKFOptionalFields104.SetupField_OverTimeBatchInfoUC" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    <tr>
        <td align="center" class="PopTableHeader" colspan="4">
            ...
            <asp:Label ID="lblSingleLine" runat="server" Text="批次加班資訊" 
    ...
    <tr>
        ...
        <td>	<asp:Label ID="lblSeq" runat="server" meta:resourcekey="lblSeqResource1"></asp:Label>
            <telerik:RadNumericTextBox ID="rdNumericEditFieldSeq" runat="server" MaxLength="3" MaxValue="999"
                    MinValue="0" Width="40px" Culture="zh-TW" DbValueFactor="1" LabelWidth="16px" meta:resourcekey="rdNumericEditFieldSeqResource1"></telerik:RadNumericTextBox></td>
    </tr>
     <tr>
            <td>
    ...
    <tr>
        <td>
            <asp:Label ID="lblFieldValidControl" runat="server" Text="事由欄位" meta:resourcekey="lblFieldValidControlResource1"></asp:Label>
        </td>
        <td colspan="3">
