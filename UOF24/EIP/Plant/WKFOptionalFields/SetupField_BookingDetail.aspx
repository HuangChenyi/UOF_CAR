    ...
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
            <td align="center" class="PopTableHeader" colspan="4">
                <center>
                <asp:Label ID="lblSingleLine" runat="server" Text="借用明細" meta:resourcekey="lblSingleLineResource1"></asp:Label>
            </center>
            </td>
        </tr>
        <tr>
        ...
        <asp:Panel ID="palVisible" runat="server" Visible="false">
            <tr>
                <td>
        ...
        <tr id="GrideDetail">
            ...
            <td colspan="3">
                <telerik:RadNumericTextBox ID="RadNumericViewLength" runat="server" MaxLength="5"
                    MaxValue="1000" MinValue="0" NullText="0" Width="40px" Culture="zh-TW" DbValueFactor="1" LabelWidth="16px" meta:resourcekey="RadNumericViewLengthResource1">
