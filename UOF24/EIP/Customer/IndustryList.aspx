<%@ Page Language="C#" MasterPageFile="~/Master/DefaultMasterPage.master" AutoEventWireup="true" Inherits="EIP_Customer_IndustryList" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="IndustryList.aspx.cs" %>
                        ...
                        <td background="<%=themePath %>/images/tree_title.gif" style="height: 30px" width="100%">
                            <table align="center" border="0" cellpadding="0" cellspacing="0" height="23" width="95%">
                                <tr>
                                    ...
                                    <td class="g">
                                        <asp:Label ID="Label2" runat="server" meta:resourcekey="Label1Resource1" Text="主檔維護列表"></asp:Label></td>
                                    <td width="3">
...
<div style="width:180">
    <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" OnButtonClick="RadToolBar1_OnButtonClick" OnClientButtonClicking="radToolBarClicking">
        <Items>
            <telerik:RadToolBarButton runat="server" Text="新增行業別" Value="btnAdd"
            ...
            <telerik:RadToolBarButton runat="server" Text="刪除行業別" Value="btnDelete"
            ...
            DefaultSortDirection="Ascending" >
                            <EnhancePagerSettings ShowHeaderPager="True" FirstAltImageUrl="" FirstImageUrl="" 
                                 ...
                                 <Columns>
                                     <asp:TemplateField HeaderText="行業別名稱" SortExpression="INDUSTRY_NAME" 
                                         meta:resourcekey="TemplateFieldResource1">
                                         <itemtemplate>
<asp:LinkButton id="lbtn" runat="server" Text='<%# Eval("INDUSTRY_NAME") %>' OnClick="lbtn_Click" 
              ...
              <asp:ObjectDataSource id="ObjectDataSource1" runat="server" TypeName="Ede.Uof.EIP.Customer.UCO.CUSIndustryUCO" StartRowIndexParameterName="intStartIndex" SortParameterName="strSortExpression" SelectMethod="GetIndustryDataSet" SelectCountMethod="GetIndustryDataSet_Count" OldValuesParameterFormatString="original_{0}" MaximumRowsParameterName="intMaxRows" EnablePaging="True">
                            <SelectParameters>
    ...
    <asp:Label ID="lblTitle" runat="server" Text="基礎資料維護 – 行業別" Visible="False" meta:resourcekey="lblTitleResource1"></asp:Label>
    <asp:Label ID="lblEdit" runat="server" Text="修改行業別" Visible="False" meta:resourcekey="lblEditResource1"></asp:Label>
    <asp:Label ID="Label1" runat="server" Text="主檔維護" Visible="False" meta:resourcekey="Label1Resource2"></asp:Label>
