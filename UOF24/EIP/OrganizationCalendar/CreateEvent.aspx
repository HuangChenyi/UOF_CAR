<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="EIP_OrganizationCalendar_CreateEvent" Title="新增事件" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="CreateEvent.aspx.cs" %>
<%@ Register TagPrefix="telerik" Namespace="Telerik.Web.UI" Assembly="Telerik.Web.UI" %>

<%@ Register Src="../Calendar/Common/UC_Periodicity.ascx" TagName="UC_Periodicity" TagPrefix="uc1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:CustomValidator ID="CustomValidator3" runat="server" Display="Dynamic" ErrorMessage="沒有設定權限" ForeColor="Red" meta:resourcekey="CustomValidator3Resource1"></asp:CustomValidator>
    <table class="PopTable" cellspacing="0" width="100%">
        ...
        <tr runat="server" id="tr_DisplayTimeZone">
            <td>
                <asp:Label ID="Label6" runat="server" Text="時區" meta:resourcekey="Label6Resource1"></asp:Label>
            </td>
            <td>
                ...
                <table border="0" cellpadding="0" cellspacing="0" >
                    ...
                    <tr>
                        <td colspan="3" >
                            ...
                            <asp:CustomValidator ID="CustomValidator6" runat="server" Display="Dynamic" ErrorMessage="週期性事件僅限當日" ForeColor="Red" OnServerValidate="CustomValidator6_ServerValidate" meta:resourcekey="CustomValidator6Resource1"></asp:CustomValidator>
                        </td>
                    </tr>
                </table>
            </td>
