    ...
    <table width="100%" class="PopTable" cellspacing="1">
        <tr>
            ...
            <td>
                ...
                <asp:CheckBox ID="cbSuspend" runat="server" Text="帳號被停用人員" meta:resourcekey="cbSuspendResource1" /></td>
        </tr>
        <tr>
            <td nowrap="noWrap" width="1%">
            ...
            <td valign="top">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <uc2:Hierarchical_Department ID="Hierarchical_Department1" runat="server" DisplayAllDept="true"/>
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        </tr>
