...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript" id="igClientScript">
        ...
        function ReturnClick() {
          <%--  if (ajaxManager == null)
            ...
            var locationhref = '';
            var hidDetailGuid = $("#<%=hidDetailGuid.ClientID %>");
            if (hidDetailGuid) {
                var detailGuid = hidDetailGuid.val();
                if (detailGuid) {
                    locationhref = '#InAppBrowserClosed';
                }
                else {
                    locationhref = '#InAppBrowserUpdateClose'
                }
            }
            else {
                locationhref = '#InAppBrowserClosed';                
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server" EnablePageHeadUpdate="false" OnAjaxRequest="RadAjaxManager1_AjaxRequest"></telerik:RadAjaxManager>
    <asp:UpdatePanel runat="server" ID="updatePanel1">
        <ContentTemplate>
            ...
            <asp:Label ID="lblUserError2" runat="server" Text="目前登入者不是此問卷的填寫者." Visible="False" meta:resourcekey="lblUserError2Resource1"></asp:Label>
            ...
            <asp:HiddenField ID="hfTargetUser" runat="server" />
