...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function ConfirmApprove() {
            ...
            if (ddlobj != null) {
                ...
                if ($('#<%=ddlUseWKFList.ClientID %> option').length == 0)
                {
                    return;
                }
            }
        ...
        function NoCreateDocAuth() {
            $uof.dialog.set_returnValue('NeedPostBack');
            alert('<%= lblNoCreateDocAuth.Text %>');
            $uof.dialog.close();
        }
    ...
    <script type="text/javascript">
        ...
        function EnableManulversion() {
            ...
            if (typeof (chkManual) != "undefined" && typeof (txtManual) != "undefined") {
                if (ischkManual) {
                    $("#<%=txtManual.ClientID%>").prop("disabled", false);
                    $("#<%=txtManual.ClientID%>").css("background-color", "#FFFFFF");
                    $("#<%=txtManual.ClientID%>").focus();
                } else {
                    $("#<%=txtManual.ClientID%>").prop("disabled", true);
        ...
        $(function () {
            ...
            if ($("#<%=chkBorrow.ClientID%>") != null)
                if ($("#<%=chkBorrow.ClientID%>").prop("disabled") == false)
                    IsBorrow();
            ...
            var dwnSecret = $("#<%=ddlSecret.ClientID %>");
        ...
        function IsBorrow() {
            ...
            if (typeof (chkBorrow) != 'undefined') {
                ...
                rblApplyRead.prop("disabled", !ischkBorrow);//rblApplyRead.disabled = !chkBorrow.checked;    
                rblReadProcedure.prop("disabled", !ischkBorrow); //rblReadProcedure.disabled = !chkBorrow.checked;
                ChoiceList1.prop("disabled", !ischkBorrow);//ChoiceList1.disabled = !chkBorrow.checked;                                                   
        ...
        function IsChangeLend() {
            ...
            if (chkBorrow != null) {
                if (chkBorrow.prop("disabled") == true) {
                    $('#ChoiceList1').prop("disabled", chkBorrow.prop("disabled"));
                }
            }
        }
        ...
        function ChangeManuStatus() {
            if ($("#<%=chkManual.ClientID%>").is(":checked")) {
                $("#<%=txtManual.ClientID%>").prop("disabled", false);  //txtManual.disabled = false;
                $("#<%=txtManual.ClientID%>").css('background-color', '#FFFFFF'); //txtManual.style.backgroundColor = "#FFFFFF";   
            }
            else {
                $("#<%=txtManual.ClientID%>").prop("disabled", true);  //txtManual.disabled = true;
    ...
    <asp:Wizard ID="Wizard1" runat="server" ActiveStepIndex="0" BackColor="#F7F6F3" BorderColor="#999999"
        ...
        <WizardSteps>
                        ...
                        <table style="height: 380px; width: 100%;" class="PopTable" cellspacing="1" id="PropertyTable" runat="server">
                            ...
                            <tr>
                             ...
                             <asp:Label ID="Label10" runat="server" Text="版本：" meta:resourcekey="Label10Resource1"></asp:Label>
                                    ...
                                    <br/>
                                    <asp:CustomValidator ID="CustomValidator5" runat="server" ErrorMessage="輸入的內容不能包括以下符號「,」、「'」、「|」、「@」、「 \」、「＂」、「、」、「{}」"  Display="Dynamic" meta:resourcekey="CustomValidator5Resource1"></asp:CustomValidator>                                  
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    <asp:TextBox ID="txtChangeReason" runat="server" Rows="4" TextMode="MultiLine"
                    ...
                    <ContentTemplate>
                        <table border="0" class="PopTable" cellspacing="1">
                            ...
                            <tr>
                                ...
                                <td style="width: 384px; height: 33px" class="PopTableRightTD">&nbsp;
                                    <asp:DropDownList ID="ddlSecret" runat="server" Width="100px" meta:resourcekey="ddlSecretResource1">
                            ...
                            <tr id="OriginalManuscriptFileTR" runat="server">
                                <td class="PopTableLeftTD" runat="server">
                                    <asp:Label ID="lblFileSourceControlTitle" runat="server" Text="主文件原稿控制" meta:resourcekey="Label18Resource1"></asp:Label>
                                </td>
                                <td style="width: 439px;" class="PopTableRightTD" runat="server">
                                    <table>
                                        ...
                                        <tr>
                                            <td style="height:25px">                                              
                                                &emsp;&emsp;<asp:CheckBox ID="chkFilePrint" runat="server" Text="可列印" AutoPostBack="True" OnCheckedChanged="chkFilePrint_CheckedChanged" meta:resourcekey="chkFilePrintResource1" />
                                            </td>
                                            <td>
                ...
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <table border="0" class="PopTable" cellspacing="1">
                            ...
                            <tr>
                                <td style="width: 15%; height: 138px;" align="right" class="PopTableLeftTD" valign="middle">
                            ...
                            <tr>
                                <td style="width: 15%;" class="PopTableLeftTD" align="right">
            ...
            <asp:WizardStep ID="WizardStep6" runat="server" Title="5.文件類別" meta:resourcekey="WizardStep6Resource1">
                <telerik:RadTreeView runat="server" ID="myClassTree" CheckBoxes="true" Height="100%" EnableNodeTextHtmlEncoding="true"
                    ...
                    <ContentTemplate>
                        <table>
                            <tr>
                             ...
                             <tr>
                                <td>
                                    <telerik:RadButton ID="btnDocRefNote" runat="server" Text="維護參考說明" Visible="false" meta:resourcekey="btnDocRefNoteResource1" OnClick="btnDocRefNote_Click" >
                                    </telerik:RadButton>
                                </td>
                            </tr>
                        </table>
                        ...
                        <asp:HiddenField ID="hidEditMode" runat="server" Value="false"/>
                        <Fast:Grid ID="gridDocRef" runat="server" AllowPaging="false" AllowSorting="True" AutoGenerateCheckBoxColumn="False" AutoGenerateColumns="False" 
                            DataKeyOnClientWithCheckBox="False" OnRowCommand="gridDocRef_RowCommand" EnhancePager="True" Width="100%" DefaultSortColumnName="DOC_NAME" 
                            OnRowDataBound="gridDocRef_RowDataBound" OnSorting="gridDocRef_Sorting" DefaultSortDirection="Ascending" EmptyDataText="No data found" 
                            KeepSelectedRows="False" meta:resourcekey="gridDocRefResource1">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="參考說明" meta:resourcekey="TemplateFieldResource7">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtDocRefNote" runat="server" Width="98%" Height="80px" TextMode="MultiLine" AutoPostBack="true" OnTextChanged="txtDocRefNote_TextChanged"></asp:TextBox>
                                        <asp:Panel ID="plDocRefNote" runat="server" CssClass="panelHeightLimit">
                                           <asp:Label ID="lblDocRefNote" runat="server" CssClass="labelMutiline"></asp:Label>
                                        </asp:Panel>
                                        <asp:HiddenField ID="hfDocRefGuid" runat="server" />
                                    </ItemTemplate>                                  
                    ...
                    <table border="0" class="PopTable" cellspacing="1">
                        <tr>
                            <td style="width: 15%; white-space: nowrap" align="right" class="PopTableLeftTD">
                                ...
                                <asp:Label ID="lblUploadFileDoc" runat="server" Text="文件內容" meta:resourcekey="lblUploadFileDocResource1"></asp:Label>
                            </td>
                            <td style="width: 85%">
                         ...
                         <tr>
                            <td style="width: 15%; white-space: nowrap" align="right" class="PopTableLeftTD">
                                <asp:Label ID="lblFileAttchment" runat="server" Text="附件" meta:resourcekey="lblFileAttchmentResource1"></asp:Label>
                            </td>
                            <td style="width: 85%">
                                <uc2:UC_FileCenter runat="server" ID="UC_FileAttchment" ProxyEnabled="true" />
                            </td>
                        </tr>
                    </table>
    ...
    <input id="hdAttachSource" runat="server" type="hidden" />
    <input id="hdAttachSaveRow" runat="server" type="hidden" />
    <input id="hdAttachPrintRow" runat="server" type="hidden" />

    <input id="hdPrintUDocRow" runat="server" type="hidden" />
    <input id="hdAllowReleaseRow" runat="server" type="hidden" />
    ...
    <asp:HiddenField ID="hfFileAttchment" runat="server" />
    ...
    <asp:Label ID="lblNoCreateDocAuth" runat="server" Text="沒有作者權限，不可新增文件" Visible="False" meta:resourcekey="lblNoCreateDocAuthResource1"></asp:Label>
