...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/jscript">
        ...
        function Button4Click2(docid, taskid) {
            $uof.dialog.open2("~/DMS/DocStore/DocInform.aspx", this, "", 900, 900, function (returnValue) {
                return false;
    ...
    <table style="width: 100%; height: 100%" class="PopTable">
        ...
        <tr runat="server" id="tr4">
            ...
            <td style="height: 25px; width: 28%; text-align: left;" id="tdDownNum" runat="server">
                <asp:Label ID="lblDownNum" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="Red" meta:resourcekey="lblDownNumResource1"></asp:Label></td>
            <td>
            ...
            <td style="height: 25px; width: 22%" runat="server" id="tdDocVersionTitle">&nbsp;<asp:Label ID="Label2" runat="server" Text="版本" meta:resourcekey="Label2Resource1"></asp:Label></td>
            <td style="height: 25px; width: 28%; text-align: left;" runat="server" id="tdDocVersion">&nbsp;<asp:Label ID="labDocVersion" runat="server" meta:resourcekey="labDocVersionResource1"></asp:Label></td>
        </tr>
        ...
        <tr runat="server" id="tr5" style="display:none">
            <td runat="server" id="tdFilePrintTitle">
                <asp:Label ID="Label7" runat="server" Text="列印次數" meta:resourcekey="lblFilePrintNumTitleResource1"></asp:Label>
            </td>
            <td runat="server" id="tdFilePrint">
                <asp:Label ID="Label15" runat="server" Font-Bold="True" Font-Size="Larger" ForeColor="Red"></asp:Label>
            </td>
            ...
            <td runat="server" id="tdPublishDate" style="height: 25px; width: 28%;">
        ...
        <tr style="text-align: left; height:100%;Width:100%;">
            <td colspan="4" class="PopTableRightTD" style="width: 100%; text-align: left;height:100%">
                ...
                <telerik:RadTabStrip ID="tabDms" runat="server" MultiPageID="tabDmsView" meta:resourcekey="RadTabStrip1Resource1">
                    <Tabs>
                ...
                <telerik:RadMultiPage ID="tabDmsView" runat="server" SelectedIndex="0" Width="100%"  Height="90%" meta:resourcekey="RadMultiPage1Resource1">
                    ...
                    <telerik:RadPageView ID="RadPageView4" runat="server" Width="100%" Height="100%" meta:resourcekey="RadPageView4Resource1">
                        <table style="width: 100%;height:100%" class="PopTable">
                            <tr>
    ...
    <asp:Label ID="Label10" runat="server" Text="原始檔案有設定密碼，無法轉檔" Visible="false" meta:resourcekey="lblFileHasPasswordResource1"></asp:Label>
    <asp:Label ID="Label12" runat="server" Text="檔案頁數超過可轉檔上限{0}頁" Visible="false" meta:resourcekey="lblFilePageOutLimitResource1"></asp:Label>
