<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="DMS_DocStore_DocLend_DocLendFlowLog" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" CodeBehind="DocLendFlowLog.aspx.cs" %>
        ...
        <table style="width: 100%;height:100%;" border="1" cellpadding="0" cellspacing="0" class="PopTable">
            <tr>
                ...
                <td class="PopTableRightTD" >
                    <asp:Label ID="lblApproveUser" runat="server" Text="Label"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="right" class="PopTableLeftTD">
