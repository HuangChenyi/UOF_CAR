<%@ Page Title="離線文件設定" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="DocOfflineSecuritySetting.aspx.cs" Inherits="Ede.Uof.Web.DMS.DocStore.DocOfflineSecuritySetting" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:HiddenField ID="hidUDocId" runat="server" />
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
