<%@ Page Title="作廢審核" Language="C#" MasterPageFile="~/Master/DefaultMasterPage.master" AutoEventWireup="true" Inherits="DMS_Person_DMSVoidApprove" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" CodeBehind="DMSVoidApprove.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <Fast:Grid ID="Grid2" runat="server" DataKeyNames="DOC_ID,MANUAL_VERSION,APPLICANT_USER" Width="100%" PageSize="15"
