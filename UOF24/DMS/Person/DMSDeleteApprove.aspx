<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DefaultMasterPage.master" AutoEventWireup="true" CodeBehind="DMSDeleteApprove.aspx.cs" Culture="auto" meta:resourcekey="PageResource1" Inherits="Ede.Uof.Web.DMS.Person.DMSDeleteApprove" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script id="Infragistics" type="text/javascript">
        ...
        function tbMainFun_Click(oToolbar, oButton, oEvent) {
            var checkedData = $uof.fastGrid.getChecked('<%=gridDocDeleteApprove.ClientID%>');
            ...
            if (button.get_value() == "Reject") {
                if (checkedData.length > 0) {
                    $uof.dialog.open2("~/DMS/DocStore/DocApproveComment.aspx", args.get_item(), "", 600, 400,
                        ...
                        , { "type": 'delete', "state": 'Reject', "data": checkedData });
                }
            }
            if (button.get_value() == "Accept") {
                if (checkedData.length > 0) {
                    $uof.dialog.open2("~/DMS/DocStore/DocApproveComment.aspx", args.get_item(), "", 600, 400,
                        ...
                        , { "type": 'delete', "state": 'Accept', "data": checkedData });
                }
            }
        }
    ...
    <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" OnButtonClick="UltraWebToolbar1_ButtonClicked" OnClientButtonClicking="UltraWebToolbar1_Click">
        <Items>
            <telerik:RadToolBarButton runat="server" Enabled="true" Text="允許" Value="Accept" meta:resourcekey="TBarButtonResource1"
                CheckedImageUrl="~/Common/Images/Icon/icon_m132.gif" DisabledImageUrl="~/Common/Images/Icon/icon_m132.gif"
            ...
            <telerik:RadToolBarButton runat="server" Enabled="true" Text="拒絕" Value="Reject" meta:resourcekey="TBarButtonResource2"
                CheckedImageUrl="~/Common/Images/Icon/icon_m141.gif" DisabledImageUrl="~/Common/Images/Icon/icon_m141.gif"
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <Fast:Grid ID="gridDocDeleteApprove" runat="server" DataKeyNames="DOC_ID,MANUAL_VERSION,APPLICANT_GUID" Width="100%" PageSize="15" 
                ...
                OnPageIndexChanging="gridDocDeleteApprove_PageIndexChanging" 
                OnRowCommand="gridDocDeleteApprove_RowCommand"
                OnRowDataBound="gridDocDeleteApprove_RowDataBound"
                OnSorting="gridDocDeleteApprove_Sorting" >
                ...
                <Columns>
                    <asp:TemplateField HeaderText="文件編號" SortExpression="DOC_SERIAL" meta:resourcekey="TemplateFieldResource7">
                        <ItemTemplate>
                            <span style="width: 80px;">
                                <asp:Label runat="server" Text='<%#: Bind("DOC_SERIAL") %>' ID="lblDocSerial" meta:resourcekey="Label1Resource1"></asp:Label>
                            </span>
                        </ItemTemplate>
                                ...
                                <table>
                                    <tr>
                                        <td style="min-width: 16px">
                                            <asp:Image ID="docIcon" runat="server" ImageUrl="~/DMS/images/icon/unknown.gif" meta:resourcekey="docIconResource1"></asp:Image>
                                            &nbsp;
                                        </td>
                                        <td>
                    ...
                    <asp:TemplateField HeaderText="操作" meta:resourcekey="TemplateFieldResource5">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="lbtnFlow2" runat="server" Text="流程" meta:resourcekey="lbtnFlow2Resource1"></asp:LinkButton>
                        </ItemTemplate>
                        <HeaderStyle Width="5%" Wrap="false" />
    ...
    <asp:Label ID="lblNoPrivilege" runat="server" Text="勾選了無權審核的文件，目錄權限已被變更" Visible="False" meta:resourcekey="lblNoPrivilegeResource1"></asp:Label>
