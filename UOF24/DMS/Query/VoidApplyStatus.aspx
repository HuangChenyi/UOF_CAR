<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DefaultMasterPage.master" AutoEventWireup="true" CodeBehind="VoidApplyStatus.aspx.cs" Inherits="Ede.Uof.Web.DMS.Query.VoidApplyStatus" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadToolBar ID="radToolBar" runat="server" Width="100%" OnButtonClick="radToolBar_ButtonClick" OnClientButtonClicking="radToolBar_Click" meta:resourcekey="radToolBarResource1" SingleClick="None">
        <Items>
        ...
        <ContentTemplate>
            <Fast:Grid ID="gridVoidApprove" runat="server" DataKeyNames="DOC_ID" Width="100%" PageSize="15"
                ...
                <Columns>
                                            ...
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td style="text-align: right;">
                                                        <asp:ImageButton ID="imgPDFViewer" CommandName="PDFViewer" CommandArgument='<%# Eval("DOC_ID")+","+Eval("MANUAL_VERSION") %>' Visible="False" runat="server" AlternateText="觀看文件" meta:resourcekey="imgPDFViewerResource1" />
                    ...
                    <asp:BoundField DataField="VOID_REASON" HeaderText="作廢原因" meta:resourcekey="BoundFieldResource7" SortExpression="VOID_REASON" > 
    ...
    <asp:Label ID="lblDocDeny" runat="server" Text="作廢拒絕" Visible="False" meta:resourcekey="lblDocDenyResource1"></asp:Label>
    ...
    <asp:Label ID="lblDocSerial" runat="server" Text="文件編號：" Visible="False" meta:resourcekey="lblDocSerialResource2"></asp:Label>
