...
td.JustAddBorder table tr td {
    ...
    <script type="text/javascript">
        ...
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            if (value == "reply") {
                ...
                args.set_cancel(true);
                $uof.dialog.open2("~/Basic/Personal/PrivateMessage/ReplyMessage.aspx", args.get_item(), "Reply Message", 1024, 768, OpenDialogResult, { "msgId": "<%=lbMsgId.Text%>", "Receive": 1, "replyall": 1 });
            }
    ...
    <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" OnButtonClick="RadToolBar1_ButtonClick" OnClientButtonClicking="RadToolBar1_ButtonClicking" meta:resourcekey="RadToolBar1Resource1">
        <Items>
            ...
            <telerik:RadToolBarButton runat="server" Text="全部回覆" Value="replyall"
                ...
                HoveredImageUrl="~/Common/Images/Icon/icon_m224.png" ImageUrl="~/Common/Images/Icon/icon_m224.png" meta:resourcekey="RadToolBarButtonResource15">
            </telerik:RadToolBarButton>
    ...
    <asp:Label ID="lblMasterGuid" runat="server" Visible="False" meta:resourcekey="lblMasterGuidResource1"></asp:Label>
