(function(angular) {
    ...
    var app = angular.module("MobileForm", ["ui.router", "angularFileUpload", "ngSanitize"]);

    app.config(function ($stateProvider, $urlRouterProvider, uofRouterProvider) {
        ...
        $stateProvider
            ...
            .state('fileDetail', {
                url: "/fileDetail/:fieldType?field",
