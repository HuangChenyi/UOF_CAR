<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="SetupField_EdocContent.aspx.cs" Inherits="Ede.Uof.Web.Edoc.WKFOptionalFields.SetupField_EdocContent" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <tr>
            <td align="center" class="PopTableHeader" colspan="4">
                <asp:Label ID="lblEdocContent" runat="server" Text="公文內容" meta:resourcekey="lblEdocContentResource1"></asp:Label></td>
        </tr>
        <tr>
        ...
        <tr id="GrideDetail">
            ...
            <td colspan="3">
                <telerik:RadNumericTextBox ID="RadNumericViewLength" runat="server" MaxLength="5"
                    MaxValue="1000" MinValue="0" NullText="0" Width="40px">
