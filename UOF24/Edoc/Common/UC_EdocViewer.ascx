<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UC_EdocViewer.ascx.cs" Inherits="Ede.Uof.Web.Edoc.Common.UC_EdocViewer" %>
        ...
        <telerik:RadToolBar ID="RadToolBar2" runat="server"  Visible="False" >
            <Items>
                <telerik:RadToolBarButton runat="server" Text="" ToolTip="Plus" Value="Plus" 
                    ...
                    CheckedImageUrl="~/dms/images/docviewer/plus.png" >
                </telerik:RadToolBarButton>
                <telerik:RadToolBarButton runat="server" Value="RatioValue"  >
                    <ItemTemplate>
                        <asp:Label ID="lblRatio" runat="server" Text="100%"></asp:Label>
                    </ItemTemplate>
                </telerik:RadToolBarButton>
                <telerik:RadToolBarButton runat="server" Text="" ToolTip="Minus" Value="Minus" 
                    ...
                    CheckedImageUrl="~/dms/images/docviewer/minus.png" >
                </telerik:RadToolBarButton>
                <telerik:RadToolBarButton Value="ratioselect" Visible="false">
                        <ItemTemplate>
                 ...
                 <telerik:RadToolBarButton Value="Left" Visible="true"  >
                     <ItemTemplate>
                     <asp:CheckBox ID="CheckBox1" runat="server" Text="置中" />
                        </ItemTemplate>
                 </telerik:RadToolBarButton>
                <telerik:RadToolBarButton runat="server" Value="sepBtnDownload" Visible="false" IsSeparator="true"></telerik:RadToolBarButton>
                <telerik:RadToolBarButton runat="server" Value="Download" Visible="false" ToolTip="Download" ImageUrl="~/Common/images/Icon/icon_m226.png"></telerik:RadToolBarButton>   
            </Items>
        </telerik:RadToolBar>           
    </div>
...
<asp:Label ID="lblDownLoading" runat="server" Text="下載檔案中，請稍後。" style="display: none;" meta:resourcekey="lblDownLoadingResource1"></asp:Label>
    ...
    <telerik:RadScriptBlock runat="server">
        <script type="text/javascript">
                ...
                <%=ClientID %>m_UgHeight = $("#<%=hdnPageRatio.ClientID %>").val() * <%=ClientID %>m_UgWidth;
                    ...
                    $("#<%=ClientID %> .book").each(function (index) {
                        ...
                        if (index === 0) {
                            ...
                            if ($("#<%=ClientID %> .book").length > 0) {
                                $(this).height($("#<%=ClientID %> .book")[0].height);
                                $(this).width($("#<%=ClientID %> .book")[0].width);
                            }
                        }
            ...
            function ratiochange_<%=ClientID %>(ratioval) {
               ...
               // $('#<%=ClientID %> .ug-image-container').width(<%=ClientID %>orgwidth);
                if ($("#<%=hdnUgWidth.ClientID %>").val() !== "") {
            ...
            function reinitial_page_<%=ClientID %>() {
                ...
                $("#<%=ClientID %> .book").removeAttr("style");
                $("#<%=ClientID %> .book").each(function (index) {
                    $(this).height(<%=ClientID %>m_UgHeight);
