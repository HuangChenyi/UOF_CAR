...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadToolBar ID="RadToolBar1" runat="server" OnButtonClick="RadToolBar1_ButtonClick" OnClientButtonClicking="RadToolBar1_ButtonClicking" Width="100%" meta:resourcekey="RadToolBar1Resource1" SingleClick="None">
        <Items>
            ...
            <telerik:RadToolBarButton runat="server" ImageUrl="~/Common/Images/Icon/icon_m101.gif" Value="SimulationFlow" HoveredImageUrl="~/Common/Images/Icon/icon_m101.gif" CheckedImageUrl="~/Common/Images/Icon/icon_m101.gif" Text="模擬流程" meta:resourceKey="TBarButtonResource3" DisabledImageUrl="~/Common/Images/Icon/icon_m101.gif">
            </telerik:RadToolBarButton>
            ...
            <telerik:RadToolBarButton runat="server" IsSeparator="True" Text="Button 3" Value="SeparatorE" meta:resourcekey="RadToolBarButtonResource2">
            </telerik:RadToolBarButton>
        </Items>
    </telerik:RadToolBar>
    ...
    <asp:Label ID="lblMultiAndApprovalTip" runat="server" Text="此站點的其他簽核者有將表單加簽給他人，可點按上方的[模擬流程]查看相關資訊。" Visible="False"  CssClass="SizeMemo" meta:resourcekey="lblMultiAndApprovalTipResource1"></asp:Label>
