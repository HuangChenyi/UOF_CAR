...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script id="OtherSiteSendjs" type="text/javascript">
        function OnBarMainClick(sender, args) {
            ...
            var nodeSeq = $uof.tool.htmlDecode('<%=System.Web.Security.AntiXss.AntiXssEncoder.HtmlEncode(currentNodeSeq.ToString(),true)%>');
            var siteId = $uof.tool.htmlDecode('<%=System.Web.Security.AntiXss.AntiXssEncoder.HtmlEncode(currentSiteId,true)%>');

            if (args.get_item().get_value() == "ReturnForm") {
            }
            else if (args.get_item().get_value() == "SimulationFlow") {
                args.set_cancel(true);
                $uof.dialog.open2("~/WKF/Browse/ViewSimulationFlow.aspx?formVersionId=" + formVersionId + "&flowId=" + flowId + 
                    "&scriptId=" + taskId + "&IS_TASK=1&NODE_SEQ=" + nodeSeq + "&SITE_ID=" + siteId,
                    args.get_item(), args.get_item().get_text(), 800, 650, openDialogResult);
            }
    ...
    <telerik:RadToolBar ID="webToolBar" runat="server" OnClientButtonClicking="OnBarMainClick"
        ...
        <Items>
            ...
            <telerik:RadToolBarButton runat="server" CausesValidation="false" meta:resourceKey="TBarButtonResource5"
                CheckedImageUrl="~/Common/Images/Icon/icon_m101.gif" DisabledImageUrl="~/Common/Images/Icon/icon_m101.gif"
                HoveredImageUrl="~/Common/Images/Icon/icon_m101.gif" ImageUrl="~/Common/Images/Icon/icon_m101.gif" 
                Text="模擬流程" Value="SimulationFlow" >
            </telerik:RadToolBarButton>
    ...
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <asp:Panel ID="PanelNextSite" runat="server" Width="100%" meta:resourcekey="PanelNextSiteResource1"
            ...
            <tr>
                ...
                <td colspan="3">
                    <uc1:UC_ChoiceList ID="UC_ChoiceList_SiteAlertUsers" runat="server" ShowMember="false" IsAllowEdit="false" />
                </td>
            </tr>
        </asp:Panel>
    </table>
    ...
    <asp:Label ID="lblNoAuth" runat="server" meta:resourcekey="lblNoAuthResource1"
                Text="無權限處理或觀看此表單" Visible="False"></asp:Label>
    ...
    <asp:Label ID="lblSignerSuspended" runat="server" Text="下一站簽核者帳號已被停用，表單送出後系統會同步通知管理員進行表單指定簽核，以避免影響簽核時效性。<br>" Visible="False" meta:resourcekey="lblSignerSuspendedResource1"></asp:Label>
