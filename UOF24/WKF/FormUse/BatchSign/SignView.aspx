...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript" src="../../../Common/javascript/jQuery/jquery.signalR-2.2.2.min.js"></script>
    <script type="text/javascript" src="BatchSign.js?v=3"></script>
    <script type="text/javascript">
        ...
        function ConnectToSignalR() {
            connection.start().done(function () {
                core.invoke('userConnected', $("#<%=hiddenKey.ClientID%>").val());
            }).fail(function (error) {
                console.log(error);
                alert('<%=lblSignalRError.Text%>');
            });

            try {
                core.on('ReturnResult', CallbackResult);
            }
            catch (ex){
                console.log(ex);
            }
        ...
        function CallbackResult(result) {
            var s = $uof.json.toObject(result);
            ...
            for (var i = 0; i < objForm.length; i++) {
                ...
                if (s[1] == "1") {
                    ...
                    switch (s[2]) {
                        ...
                        case "20": label.html("<br><%=lbl_Fail.Text%><%=lblBackgroundProcessing.Text%>"); break;
