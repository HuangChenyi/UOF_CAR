                                    ...
                                    <telerik:CompositeLayoutColumn Span="12">
                                        <Content>
                                            <h3 class="blockheader">
                                                <asp:Label ID="Label9" runat="server" Text="申請資訊" meta:resourcekey="Label9Resource1"></asp:Label></h3>
                                        </Content>
                                        <Rows>
                                            <telerik:LayoutRow RowType="Generic" CssClass="content">
                                                <Rows>
                            ...
                            <telerik:LayoutRow RowType="Container" WrapperHtmlTag="Div">
                                <Columns>
                                    <telerik:CompositeLayoutColumn Span="12">
                                        <Content>
                                            <h3 class="blockheader">
                                                <asp:Label ID="Label12" runat="server" Text="表單" meta:resourcekey="Label12Resource1"></asp:Label></h3>
                                        </Content>
                                        <Rows>
                            ...
                            <telerik:LayoutRow RowType="Container" WrapperHtmlTag="Div">
                                <Columns>
                                    <telerik:CompositeLayoutColumn id="AttachmentsByForm" runat="server" Span="12">
                                        <Content>
                                            <h3 class="blockheader">
                                                <asp:Label ID="Label10" runat="server" Text="相關附件(表單)" meta:resourcekey="Label10Resource1"></asp:Label></h3>
                                        </Content>
                                        <Rows>
                                    ...
                                    <telerik:CompositeLayoutColumn id="AttachmentsBySite" runat="server" Span="12">
                                        <Content>
                                            <h3 class="blockheader">
                                                <asp:Label ID="Label11" runat="server" Text="個人附件(站點)" meta:resourcekey="Label11Resource1"></asp:Label></h3>
                                        </Content>
                                        <Rows>
                                            <telerik:LayoutRow RowType="Generic" CssClass="content nopadding">
                                                <Columns>
                            ...
                            <telerik:LayoutRow RowType="Container" WrapperHtmlTag="Div">
                                <Columns>
                                    <telerik:CompositeLayoutColumn Span="12">
                                        <Content>
                                            <h3 class="blockheader">
                                                <asp:Label ID="Label13" runat="server" Text="意見" meta:resourcekey="Label13Resource1"></asp:Label></h3>
                                        </Content>
                                        <Rows>
                                            <telerik:LayoutRow RowType="Generic" CssClass="content nopadding">
                                                <Columns>
    ...
    <table width="100%" cellpadding="0" cellpadding="0" border="0" height="100%" style="display: none">
        <tr>
            <td style="background-image: url(<%=themePath %>/images/wf_bg.gif); vertical-align: top">
                                ...
                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td style="background-image: url(<%=themePath %>/images/wf_a01.jpg);background-repeat:repeat-x;height:65px;background-position: 0% 100%;">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td class="bigT" style="vertical-align: middle;text-align:left; height: 65px"></td>
                                                            ...
                                                            <table style="text-align:right;width:100%">
                                                                <tr>
                                                                    <td>
                                                                        ...
                                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidatorScriptName" runat="server" 
                                                                            ControlToValidate="tbxScriptName" Display="Dynamic" ErrorMessage="請輸入草稿名稱" meta:resourcekey="RequiredFieldValidatorScriptNameResource1">
                ...
                <asp:Label ID="lblSpeedSendFailedMessage" runat="server" Text="快速送出失敗：" Visible="true" ForeColor="Red" meta:resourcekey="lblSpeedSendFailedMessageResource1" ></asp:Label>
