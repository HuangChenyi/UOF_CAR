...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function Return() {
            if (window.location.href.indexOf('&return=') >= 0)
                return true;

            setInterval(function () { window.location.href = '#InAppBrowserClosed'; }, 300);
            return false;
        }
                                    ...
                                    <tr>
                                        ...
                                        <td style="background-image: url(<%=themePath %>/images/wf_a04.gif)">
                                            <table width="100%">
                                                <tr>
                                                    <td colspan="3">
                                                        <telerik:RadToolBar ID="webToolBar" runat="server"
