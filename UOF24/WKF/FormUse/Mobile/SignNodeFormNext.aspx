...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function NewAdditionClick(checkComment) {
            if (checkComment  == 'true') {
                var comment = $('#<% = txtComment.ClientID %>');
        ...
        function signDialogResult(returnValue) {
            ...
            if (typeof (returnValue) == 'undefined') {
                ...
                if (returnValue == "NextSite") {
                    ...
                    var data = [paras.taskId, paras.siteId, paras.nodeSeq, paras.queryType, paras.keyword, paras.sort, paras.index, paras.categoryId, paras.agent];
                    ...
                    location.href = "../ViewFormNext.aspx?TASK_ID=" + paras.taskId + "&SignedStatus=IsSigned&isMNext=true";
                }
                else {
                    window.close();
                    return true;
                                            ...
                                            <telerik:LayoutRow RowType="Container" CssClass="content">
                                                <Columns>
                                                    <telerik:CompositeLayoutColumn Span="12" CssClass="validateFocus">
                                                        <Content>
                                                            <div>
                                                                <asp:Label ID="lblSpeedSignFailedMessage" runat="server" Text="前次快速簽核失敗："
                                                                Visible="false" ForeColor="Red" meta:resourcekey="lblSpeedSignFailedMessageResource1" >
                                                            </asp:Label>
                                                            </div>
                                                            <div>
                                                    ...
                                                    <telerik:LayoutColumn Span="12">
                                                        ...
                                                        <div id="divFC" runat="server" style="text-align:left">
                                                         ...
                                                         <div id="divFOP" runat="server" style="text-align:left;overflow-x:scroll">
                                                                <uc9:UC_FileOnlinePreview runat="server" ID="UC_FileOnlinePreview" IsMobile="true" />
                                                            </div>
                                                ...
                                                <Columns>
                                                    <telerik:LayoutColumn Span="12">
                                                        ...
                                                        <div id="divFOPPersonal" runat="server" style="text-align:left;overflow-x:scroll">
                                                                <uc9:UC_FileOnlinePreview runat="server" ID="UC_FileOnlinePreviewPersonal" IsMobile="true" />
                                                            </div>
