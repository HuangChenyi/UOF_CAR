                ...
                <table width="100%" class="PopTable" cellspacing="1">
                    ...
                    <tr style="display: none">
                        <td>
                            <asp:Label ID="lblMasterFlow" runat="server"  Text="主流程"
                                meta:resourcekey="lblMasterFlowResource1"></asp:Label>
                        </td>
                        <td>
                    ...
                    <asp:Panel ID="PanelNextSite" runat="server" Width="100%" meta:resourcekey="PanelNextSiteResource1" CssClass="panelDiv">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td>
                                <asp:Label ID="lblNextSiteAlerter" runat="server" Text="知會人員" meta:resourcekey="lblNextSiteAlerterResource1"></asp:Label>
                            </td>
                            <td>
