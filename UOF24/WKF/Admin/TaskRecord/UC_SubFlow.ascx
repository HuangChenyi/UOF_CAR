<%@ Control Language="C#" AutoEventWireup="true" Inherits="WKF_Admin_TaskRecord_UC_SubFlow" Codebehind="UC_SubFlow.ascx.cs" %>
    ...
    <tr>
        <td colspan="2" style="height: 107px; text-align: center; vertical-align:middle; background-color: #a9a9a9;
            ...
            <table bordercolordark="#000000" bordercolorlight="#ffffff" cellpadding="0" cellspacing="1"
                ...
                <tr>
                    <td bgcolor="#ffffff" colspan="3" rowspan="3" style="text-align: center; background-color:#ffffff" valign="top">
                        <br />
                        <center>
