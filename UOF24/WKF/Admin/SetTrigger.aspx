    ...
    <script type="text/javascript" id="telerikClientEvents1">
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            if (value == "InsertButton") {
                ...
                $uof.dialog.open2("~/WKF/Admin/AddTrigger.aspx", args.get_item(), '<%=lblTriggerTitleName.Text%>', 550, 350, openDialogResult, {"Action":"Insert"});
               }
                            ...
                            <td>
                                <Fast:Grid ID="TriggerGrid" runat="server" AutoGenerateCheckBoxColumn="True" 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="FILE" HeaderText="DLL名稱" SortExpression="FILE" 
