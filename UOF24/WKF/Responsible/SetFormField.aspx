...
<script id="treejs" type="text/javascript">
        ...
        <tr>
                                        ...
                                        <tr>
                                            <td style="width: 50%; text-align: center" class="PopTableLeftTD" align="center" height="20">
                                                ...
                                                <asp:CustomValidator ID="CustomValidator1" runat="server" Display="Dynamic" 
                                                    ErrorMessage="CustomValidator" meta:resourcekey="CustomValidator1Resource1">
                                                </asp:CustomValidator>
                                            </td>
                                        </tr>
                                        <tr>
            ...
            <td style="min-width:50px;vertical-align:middle;text-align:center">
                <telerik:RadButton ID="btnAdd" runat="server"  CausesValidation="False"
                    meta:resourcekey="btnAddResource1" OnClick="btnAdd_Click1" Text="<--">
                </telerik:RadButton>
                &nbsp;
                <br />
                <br />
                <telerik:RadButton ID="btnRemove" runat="server" meta:resourcekey="btnRemoveResource1" 
                    OnClick="btnRemove_Click1" Text="-->">
                </telerik:RadButton>
            </td>
            <td valign="top" width="47%" style="vertical-align:top;border-width:1px;border-color:black;border-style:solid">
                <table cellspacing="0" cellpadding="0" width="100%" border="1" height="100%">
    ...
    <asp:HiddenField ID="hfDropSourceNode" runat="server" />
    ...
    <asp:Label ID="lbl_applicant" runat="server" Visible="False" 
        meta:resourcekey="lbl_applicantResource1" Text="申請者">
    </asp:Label>
    <asp:Label ID="lbl_applicantStartTime" runat="server" Visible="False" 
        meta:resourcekey="lbl_applicantStartTimeResource1" Text="申請時間">
    </asp:Label>
    <asp:Label ID="lbl_applicantEndTime" runat="server" Visible="False" 
        meta:resourcekey="lbl_applicantEndTimeResource1" Text="結案時間">
    </asp:Label>
    <asp:Label ID="lbl_applicantDocNbr" runat="server" Visible="False" 
        meta:resourcekey="lbl_applicantDocNbrResource1" Text="表單編號">
    </asp:Label>
    <asp:Label ID="lbl_applicantStatus" runat="server" Visible="False" 
        meta:resourcekey="lbl_applicantStatusResource1" Text="目前狀態">
    </asp:Label>
    <asp:Label ID="lbl_applicantCurrentSigner" runat="server" Visible="False" 
        meta:resourcekey="lbl_applicantCurrentSignerResource1" Text="目前簽核者">
    </asp:Label>
    <asp:Label ID="lbl_jobTitle" runat="server" Visible="False" 
        meta:resourcekey="lbl_jobTitleResource1" Text="職級">
    </asp:Label>
    <asp:Label ID="lbl_SystemDefaultAlert" runat="server" Visible="False" 
        meta:resourcekey="lbl_SystemDefaultAlertResource1" Text="系統預設顯示欄位不可刪除!!">
    </asp:Label>
    <asp:Label ID="lbl_formTitle" runat="server" Visible="False" 
        meta:resourcekey="lbl_formTitleResource1" Text="表單標題">
    </asp:Label>
