...
<script type="text/javascript">
    ...
    function cvExcludeApplicant_<%=UC_ChoiceListMobile.ClientID%>(e, arg) {
        ...
        var result = $uof.pageMethod.syncUc('WKF/FormManagement/VersionFieldUserControl/AllUserSetMobileUC.ascx', 'IsIncludeApplicant', data, function (response) { });
        if (result == "True") {
            arg.IsValid = false;
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 97%">
            ...
            <tr>
                ...
                <td colspan="2">
                    ...
                    <asp:CustomValidator ID="cvCheckExcludeAppliant" runat="server" ErrorMessage="不允許選擇申請者" ForeColor="Red"
                        SetFocusOnError="true" EnableTheming="true" Display="Dynamic" meta:resourcekey="cvCheckExcludeAppliantResource1">
                    </asp:CustomValidator>
                </td>
            </tr>
        </table>
