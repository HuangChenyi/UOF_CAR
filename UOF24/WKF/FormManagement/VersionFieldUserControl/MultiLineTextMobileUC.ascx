        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 97%">
            ...
            <tr>
                ...
                <td id="tdVisible" runat="server">
                    ...
                    <asp:Label ID="lblMultiLineText" runat="server" Visible="False" style="word-break:break-all;display:inline-block" meta:resourcekey="lblMultiLineTextResource1"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
