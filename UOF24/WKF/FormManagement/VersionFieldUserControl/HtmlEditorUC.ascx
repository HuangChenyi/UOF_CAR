...
<table border="0" cellpadding="0" cellspacing="0" style="width: 99%" id="tbField" runat="server">
    ...
    <tr id="trVisible" runat="server">
        <td style="word-break: break-all; white-space: normal">
            ...
            <div>
                <asp:TextBox ID="txtEditor" runat="server" Width="99%" TextMode="MultiLine" Height="300px" meta:resourcekey="txtEditorResource1"></asp:TextBox>
                <uc1:UC_HtmlEditor runat="server" ID="RadEditor1" ModuleName="WKF" EnableTheming="True" />
    ...
    <tr>
        <td colspan="2">
            ...
            <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="不允許空白" Display="Dynamic" ForeColor="Red" Visible="False" meta:resourcekey="CustomValidator1Resource1"></asp:CustomValidator>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtEditor" ForeColor="Red" ErrorMessage="不允許空白" Visible="False" Display="Dynamic" SetFocusOnError="True" meta:resourcekey="RequiredFieldValidator2Resource1"></asp:RequiredFieldValidator>
