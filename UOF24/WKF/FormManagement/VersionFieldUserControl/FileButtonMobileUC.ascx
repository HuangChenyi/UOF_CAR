...
<asp:UpdatePanel ID="updatePanel1" runat="server">
    <ContentTemplate>
        <table cellpadding="0" cellspacing="0" border="0" style="width: 97%; table-layout: fixed" id="tbField" runat="server">
            ...
            <tr>
                <td style="max-width: 60px" runat="server" id="tdEdit">
                    ...
                    <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="false" ForeColor="OliveDrab" OnClick="LinkButton1_Click" meta:resourcekey="LinkButton1Resource1" Text="檔案操作"
                         style="-webkit-text-size-adjust: 100%"></asp:LinkButton>
                </td>
            </tr>
