...
<style>
    .radio-button-other-modify input {
        float: left;
        margin-top: 5px;
    }

    .radio-button-list-modify input {
        float: left;
        margin-top: 5px;
    }

    .radio-button-list-modify label {
        margin-left: 15px;
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="width: 97%">
            ...
            <tr id="trField" runat="server">
                ...
                <td>
                    ...
                    <asp:RadioButtonList ID="rbList" runat="server" class="printFullOption" RepeatDirection="Horizontal" meta:resourcekey="rbListResource1" CssClass="radio-button-list-modify"></asp:RadioButtonList>
                        </div>
                    <asp:Label ID="lblList" runat="server" class="printSimpleLabel" meta:resourcekey="lblListResource1"></asp:Label>
            ...
            <tr id="trOthers" class="printFullOption" runat="server">
                <td>
                    <asp:RadioButton ID="rbOthers" runat="server" Text="其他" CssClass="radio-button-other-modify" meta:resourcekey="rbOthersResource1" />
            ...
            <tr>
                <td colspan="2">
                    <asp:CustomValidator ID="CustomValidator1" runat="server" Display="Dynamic" ErrorMessage="不允許空白"
                        ...
                        Visible="false" meta:resourcekey="CustomValidator1Resource1" EnableTheming="true">
                    </asp:CustomValidator>
