...
<script language="javascript">
    ...
    function HyperLinkClick_<%=this.VersionField.FieldID%>(url) {
        var ajaxManager;
        if (ajaxManager == null)
        ...
        setInterval(function () {
            window.location.href = '#InAppBrowserIOSRedirect:' + url;
        }, 200);
    ...
    function Clicking(e, args) {
        ...
        setTimeout(function() {location.replace(button2);}, 500);
    }
</script>
