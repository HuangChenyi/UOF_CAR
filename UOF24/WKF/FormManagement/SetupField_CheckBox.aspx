    ...
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
            ...
            <asp:UpdatePanel ID="UpdatePanelCBL" runat="server" UpdateMode="Conditional">
                ...
                <asp:CustomValidator ID="CvCbxOthersUsedInConditions" runat="server" Display="Dynamic"
                    ErrorMessage="此欄位已被設定為表單條件，不允許變更或刪除選項！" meta:resourcekey="CvCbxOthersUsedInConditionsResource1"></asp:CustomValidator>&nbsp;
            </td>
        </tr>
        <tr>
            <td>
