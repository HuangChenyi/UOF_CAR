<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="SetupFieldHyperLink.aspx.cs" Inherits="WKF_FormManagement_SetupFieldHyperLink" %>
...
<style type="text/css"> 
    ...
    <script>
         function Sure() {
            console.log(GetRadWindow().BrowserWindow);
