<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_FormManagement_SetupDataGridField" Title="明細欄位維護" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SetupDataGridField.aspx.cs" %>
   ...
   <tr>
      <td>
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
              <tr>
                  <td>
                      <uc1:UC_VersionFieldCollection runat="server" ID="UC_VersionFieldCollection" />
