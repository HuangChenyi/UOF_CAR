...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <style>
     ...
     <script type="text/javascript">
         ...
         function RadToolBar1_ButtonClicking(sender, args) {
             ...
             var isModify = $uof.tool.htmlDecode('<%=System.Web.Security.AntiXss.AntiXssEncoder.HtmlEncode(Request.QueryString["IsModify"],true)%>');
             var formVersionId = $uof.tool.htmlDecode('<%=System.Web.Security.AntiXss.AntiXssEncoder.HtmlEncode(formVersionId,true)%>');
             var siteId = $uof.tool.htmlDecode('<%=System.Web.Security.AntiXss.AntiXssEncoder.HtmlEncode(siteId,true)%>');
 ...
 <table class="PopTable PageStyle">
     <tr>
         <td>
