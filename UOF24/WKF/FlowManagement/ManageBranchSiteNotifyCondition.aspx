<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_FlowManagement_ManageBranchSiteNotifyCondition" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" Codebehind="ManageBranchSiteNotifyCondition.aspx.cs" %>
...
<script id="btnjs" type="text/javascript">
    function btnAdd_Clicking(sender, args) {
    ...
    <table width="100%">
        <tr>
            <td valign="top" width="40%" style="height:525px">
                        <table  class="PopTable" style="width:100%;height:525px" cellspacing="1" cellpadding="0" >
                            <tbody>
                                ...
                                <tr>
                                    <td style="height:525px" class="PopTableRightTD" valign="top" width="50%">
            ...
            <td style="vertical-align:middle;min-width:50px">
                <telerik:RadButton ID="btnAdd" runat="server" CausesValidation="False" Text="<--"
                    meta:resourcekey="btnAddResource1" OnClick="btnAdd_Click1" OnClientClicking="btnAdd_Clicking"></telerik:RadButton>
                &nbsp;
                <br />
                <br />
                <telerik:RadButton ID="btnRemove" runat="server" meta:resourcekey="btnRemoveResource1" Text="-->" 
                    OnClick="btnRemove_Click1"></telerik:RadButton>
            </td>
            <td valign="top" style="width:56%;height:525px">
