<%@ Control Language="C#" AutoEventWireup="true" Inherits="WKF_FlowManagement_Layout_UC_FieldSite" Codebehind="UC_FieldSite.ascx.cs" %>
...
<tr>
    ...
    <tr>
        <td style="height:21px;vertical-align:bottom;text-align: center;background-image:url(<%=themePath %>/images/wkf/app_top.gif); background-repeat:no-repeat; background-position:bottom;"  colspan="3" >
        <center>
    ...
    <tr>
        <td class="SiteLeftTD" valign="top" width="10">
            &nbsp;</td>
        <td style="width:125px;vertical-align:top;height:60px;background-image:url(<%=themePath %>/images/wkf/site_con.gif)" >
            <table cellpadding="0" cellspacing="0" width="100%" border="0">
                <tr style="height:20px">
                    <td  style="text-align:center;word-break:keep-all"><asp:ImageButton ID="imgSiteType" runat="server" ImageUrl="site_normal.gif" meta:resourcekey="imgSiteTypeResource1" ToolTip="觀看站點" /></td>
