<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_FlowManagement_SelFieldList" Title="選擇欄位" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SelFieldList.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <tr>
            <td class = "PopTableHeader" style="text-align: center; height: 26px;" >
                <asp:Label ID="lblFormList" runat="server" Text="欄位選擇" meta:resourcekey="lblFormListResource1"></asp:Label></td>
        </tr>
        <tr>
            <td>
