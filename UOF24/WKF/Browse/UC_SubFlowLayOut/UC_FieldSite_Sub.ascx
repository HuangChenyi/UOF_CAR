<%@ Control Language="C#" AutoEventWireup="true" Inherits="WKF_Browse_UC_SubFlowLayOut_UC_FieldSite_Sub" Codebehind="UC_FieldSite_Sub.ascx.cs" %>
...
<table cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td width="125" valign="top" class="SiteMiddleTD">
