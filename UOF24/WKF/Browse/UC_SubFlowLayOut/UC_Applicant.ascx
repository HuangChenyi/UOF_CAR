<%@ Control Language="C#" AutoEventWireup="true" Inherits="WKF_Browse_UC_SubFlowLayOut_UC_Applicant" Codebehind="UC_Applicant.ascx.cs" %>
<table cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="SiteMiddleTD" valign="top" width="125">
            <div align="center" >
                &nbsp;<asp:Label ID="Label1" runat="server" Text="申請者" ForeColor="Blue" meta:resourcekey="Label1Resource1"></asp:Label></div>
        </td>
